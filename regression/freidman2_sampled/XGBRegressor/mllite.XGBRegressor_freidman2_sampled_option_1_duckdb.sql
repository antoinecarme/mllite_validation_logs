...
"DT_node_data_1" AS 
 (SELECT
    ...
    "Values"."E" AS "E"
  FROM (
    SELECT 1 AS nid,  -45.942249 AS "E"
    UNION ALL
    SELECT 2 AS nid,  62.294556 AS "E"
  ) AS "Values"
 )
,
"DT_output_1" AS 
...
"DT_node_lookup_2" AS 
 (SELECT
    t."index" AS "index",
    CASE WHEN (t."X_2" < 0.652046) THEN 1 ELSE 2 END AS node_id
  FROM model_input AS t
 )
,
"DT_node_data_2" AS 
 (SELECT
    ...
    "Values"."E" AS "E"
  FROM (
    SELECT 1 AS nid,  -43.145218 AS "E"
    UNION ALL
    SELECT 2 AS nid,  44.468971 AS "E"
  ) AS "Values"
 )
,
"DT_output_2" AS 
...
"DT_node_data_3" AS 
 (SELECT
    ...
    "Values"."E" AS "E"
  FROM (
    SELECT 1 AS nid,  -37.611706 AS "E"
    UNION ALL
    SELECT 2 AS nid,  38.595074 AS "E"
  ) AS "Values"
 )
,
"DT_output_3" AS 
...
"DT_node_lookup_4" AS 
 (SELECT
    t."index" AS "index",
    CASE WHEN (t."X_2" < 0.720020) THEN 1 ELSE 2 END AS node_id
  FROM model_input AS t
 )
,
"DT_node_data_4" AS 
