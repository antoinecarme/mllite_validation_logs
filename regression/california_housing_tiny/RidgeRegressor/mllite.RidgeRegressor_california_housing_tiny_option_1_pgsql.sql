...
model_scores_cte AS 
 (SELECT
  t."index" AS "index",
   -4976790.000000 + -62646.570312 * t."X_0" + -67465.765625 * t."X_1" + 2350.610107 * t."X_2" + 75.704346 * t."X_3" + -82.839996 * t."X_4" + -146.247528 * t."X_5" + -8.188899 * t."X_6" + 12813.508789 * t."X_7" + 0.000000 * t."X_8" AS "Estimator"
