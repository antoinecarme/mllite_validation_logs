...
,"SV_data" AS
 ( SELECT 
  ...
  FROM
  (
     SELECT 0 AS "sv_idx", -0.800000 AS "coeff", -121.580002 AS "sv_0", 39.500000 AS "sv_1", 29.000000 AS "sv_2", 1947.000000 AS "sv_3", 383.000000 AS "sv_4", 925.000000 AS "sv_5", 337.000000 AS "sv_6", 2.165800 AS "sv_7", 0.000000 AS "sv_8"
     UNION ALL
     SELECT 1 AS "sv_idx", 0.800000 AS "coeff", -122.440002 AS "sv_0", 37.779999 AS "sv_1", 52.000000 AS "sv_2", 1118.000000 AS "sv_3", 279.000000 AS "sv_4", 514.000000 AS "sv_5", 284.000000 AS "sv_6", 2.419600 AS "sv_7", 0.000000 AS "sv_8"
   ) AS "Values"
 )
,"Kernel_DotProd" AS
 ( SELECT
   ...
   FROM
    (SELECT
      ...
      sum(CAST(full_join_data_sv.dot_prod AS FLOAT)) - -201900.000000 AS dot_product
     FROM
       (SELECT
