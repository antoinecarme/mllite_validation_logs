...
,"SV_data" AS
 ( SELECT 
  ...
  (
     ...
     UNION ALL
     SELECT 4 AS "sv_idx", 0.357008 AS "coeff", 63.010204 AS "sv_0", 221.354385 AS "sv_1", 0.814630 AS "sv_2", 5.897069 AS "sv_3"
     UNION ALL
     SELECT 5 AS "sv_idx", 0.428455 AS "coeff", 22.605108 AS "sv_0", 1660.837036 AS "sv_1", 0.731124 AS "sv_2", 9.374556 AS "sv_3"
     UNION ALL
     SELECT 6 AS "sv_idx", 1.000000 AS "coeff", 13.280704 AS "sv_0", 643.716797 AS "sv_1", 0.520814 AS "sv_2", 4.842079 AS "sv_3"
     UNION ALL
     SELECT 7 AS "sv_idx", 0.708032 AS "coeff", 7.606344 AS "sv_0", 1112.226562 AS "sv_1", 0.732761 AS "sv_2", 6.140375 AS "sv_3"
     UNION ALL
     SELECT 8 AS "sv_idx", 0.506505 AS "coeff", 94.566437 AS "sv_0", 663.266418 AS "sv_1", 0.852323 AS "sv_2", 6.919084 AS "sv_3"
     UNION ALL
 ...
 ( SELECT
   ...
   FROM
    (SELECT
      ...
      sum(CAST(full_join_data_sv.dot_prod AS FLOAT)) - -1.319479 AS dot_product
     FROM
       (SELECT
