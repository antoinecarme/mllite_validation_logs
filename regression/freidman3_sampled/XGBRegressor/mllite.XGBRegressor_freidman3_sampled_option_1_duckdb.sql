...
"DT_node_data_1" AS 
 (SELECT
    ...
    "Values"."E" AS "E"
  FROM (
    SELECT 1 AS nid,  -0.034395 AS "E"
    UNION ALL
    SELECT 2 AS nid,  0.034395 AS "E"
  ) AS "Values"
 )
,
"DT_output_1" AS 
...
"DT_node_data_2" AS 
 (SELECT
    ...
    "Values"."E" AS "E"
  FROM (
    SELECT 1 AS nid,  -0.027141 AS "E"
    UNION ALL
    SELECT 2 AS nid,  0.027141 AS "E"
  ) AS "Values"
 )
,
"DT_output_2" AS 
...
"DT_node_data_3" AS 
 (SELECT
    ...
    "Values"."E" AS "E"
  FROM (
    SELECT 1 AS nid,  -0.023224 AS "E"
    UNION ALL
    SELECT 2 AS nid,  0.023224 AS "E"
  ) AS "Values"
 )
,
"DT_output_3" AS 
