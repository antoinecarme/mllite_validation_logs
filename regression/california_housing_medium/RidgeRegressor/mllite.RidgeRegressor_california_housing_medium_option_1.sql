...
model_scores_cte AS 
 (SELECT
  model_input."index" AS "index",
   27758342.000000 + 655467.437500 * X_0 + 1387063.375000 * X_1 + -130.976746 * X_2 + -4.065172 * X_3 + -70.044510 * X_4 + -3.429034 * X_5 + 136.405609 * X_6 + 29117.230469 * X_7 + 0.000000 * X_8 AS "Estimator"
  FROM model_input
 )
SELECT
