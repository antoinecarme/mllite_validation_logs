...
model_scores_cte AS 
 (SELECT
  t."index" AS "index",
   27185504.000000 + 648273.250000 * t."X_0" + 1378945.875000 * t."X_1" + -125.704155 * t."X_2" + -3.606839 * t."X_3" + -47.915974 * t."X_4" + -3.393404 * t."X_5" + 110.849892 * t."X_6" + 29144.734375 * t."X_7" + 0.000000 * t."X_8" AS "Estimator"
