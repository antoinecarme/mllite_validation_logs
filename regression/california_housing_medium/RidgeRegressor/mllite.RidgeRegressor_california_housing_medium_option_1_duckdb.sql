...
model_scores_cte AS 
 (SELECT
  t."index" AS "index",
   27758342.000000 + 655467.437500 * t."X_0" + 1387063.375000 * t."X_1" + -130.976746 * t."X_2" + -4.065172 * t."X_3" + -70.044510 * t."X_4" + -3.429034 * t."X_5" + 136.405609 * t."X_6" + 29117.230469 * t."X_7" + 0.000000 * t."X_8" AS "Estimator"
