...
model_scores_cte AS 
 (SELECT
  model_input."index" AS "index",
   27185504.000000 + 648273.250000 * X_0 + 1378945.875000 * X_1 + -125.704155 * X_2 + -3.606839 * X_3 + -47.915974 * X_4 + -3.393404 * X_5 + 110.849892 * X_6 + 29144.734375 * X_7 + 0.000000 * X_8 AS "Estimator"
  FROM model_input
 )
SELECT
