...
model_scores_cte AS 
 (SELECT
  model_input."index" AS "index",
   -3482644.750000 + -41807.437500 * X_0 + -42025.828125 * X_1 + 1155.277344 * X_2 + -6.938964 * X_3 + 66.372299 * X_4 + -39.290848 * X_5 + 90.049385 * X_6 + 38812.687500 * X_7 + 0.000000 * X_8 AS "Estimator"
  FROM model_input
 )
SELECT
