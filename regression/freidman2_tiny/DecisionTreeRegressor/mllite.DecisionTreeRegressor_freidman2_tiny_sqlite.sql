...
"DT_node_data" AS 
 (SELECT
  ...
  FROM (
    ...
    UNION ALL
    SELECT 29 AS nid, 720.185913 AS "E"
    UNION ALL
    SELECT 30 AS nid, 730.257019 AS "E"
  ) AS "Values"
 ),
"DT_Output" AS 
 (SELECT
