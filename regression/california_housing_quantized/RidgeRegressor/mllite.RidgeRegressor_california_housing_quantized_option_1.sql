...
model_scores_cte AS 
 (SELECT
  model_input."index" AS "index",
   270228.500000 + -23248.501953 * X_0 + -23922.412109 * X_1 + 5887.901855 * X_2 + -492.822052 * X_3 + 10715.501953 * X_4 + -16666.689453 * X_5 + 8507.838867 * X_6 + 24955.617188 * X_7 + 0.000000 * X_8 AS "Estimator"
  FROM model_input
 )
SELECT
