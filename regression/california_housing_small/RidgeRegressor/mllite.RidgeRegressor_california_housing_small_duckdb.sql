...
model_scores_cte AS 
 (SELECT
  t."index" AS "index",
   -2985873.500000 + -38126.550781 * t."X_0" + -42996.593750 * t."X_1" + 430.191437 * t."X_2" + -10.977800 * t."X_3" + 223.917358 * t."X_4" + -32.853371 * t."X_5" + -97.840607 * t."X_6" + 39899.785156 * t."X_7" + 0.000000 * t."X_8" AS "Estimator"
