...
model_scores_cte AS 
 (SELECT
  model_input."index" AS "index",
   -4586773.500000 + -57234.671875 * X_0 + -62603.500000 * X_1 + 474.539032 * X_2 + -26.500479 * X_3 + 527.264893 * X_4 + -28.808113 * X_5 + -345.030731 * X_6 + 42478.109375 * X_7 + 0.000000 * X_8 AS "Estimator"
  FROM model_input
 )
SELECT
