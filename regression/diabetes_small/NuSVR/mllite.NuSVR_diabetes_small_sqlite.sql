...
,"SV_data" AS
 ( SELECT 
  ...
  (
     ...
     UNION ALL
     SELECT 1 AS "sv_idx", -1.000000 AS "coeff", 0.041708 AS "sv_0", -0.044642 AS "sv_1", -0.008362 AS "sv_2", -0.026328 AS "sv_3", 0.024574 AS "sv_4", 0.016222 AS "sv_5", 0.070730 AS "sv_6", -0.039493 AS "sv_7", -0.048359 AS "sv_8", -0.030072 AS "sv_9"
     UNION ALL
     ...
     UNION ALL
     SELECT 4 AS "sv_idx", 1.000000 AS "coeff", 0.016281 AS "sv_0", 0.050680 AS "sv_1", 0.014272 AS "sv_2", 0.001215 AS "sv_3", 0.001183 AS "sv_4", -0.021355 AS "sv_5", -0.032356 AS "sv_6", 0.034309 AS "sv_7", 0.074966 AS "sv_8", 0.040343 AS "sv_9"
     UNION ALL
     ...
     UNION ALL
     SELECT 28 AS "sv_idx", -1.000000 AS "coeff", -0.034575 AS "sv_0", 0.050680 AS "sv_1", -0.055785 AS "sv_2", -0.015999 AS "sv_3", -0.009825 AS "sv_4", -0.007890 AS "sv_5", 0.037595 AS "sv_6", -0.039493 AS "sv_7", -0.052963 AS "sv_8", 0.027917 AS "sv_9"
     UNION ALL
     SELECT 29 AS "sv_idx", -1.000000 AS "coeff", 0.016281 AS "sv_0", 0.050680 AS "sv_1", -0.046085 AS "sv_2", 0.011544 AS "sv_3", -0.033216 AS "sv_4", -0.016032 AS "sv_5", -0.010266 AS "sv_6", -0.002592 AS "sv_7", -0.043984 AS "sv_8", -0.042499 AS "sv_9"
     UNION ALL
     SELECT 30 AS "sv_idx", 1.000000 AS "coeff", 0.045341 AS "sv_0", 0.050680 AS "sv_1", 0.068163 AS "sv_2", 0.008101 AS "sv_3", -0.016704 AS "sv_4", 0.004636 AS "sv_5", -0.076536 AS "sv_6", 0.071210 AS "sv_7", 0.032432 AS "sv_8", -0.017646 AS "sv_9"
     UNION ALL
     SELECT 31 AS "sv_idx", 1.000000 AS "coeff", -0.027310 AS "sv_0", 0.050680 AS "sv_1", 0.060618 AS "sv_2", 0.107944 AS "sv_3", 0.012191 AS "sv_4", -0.017598 AS "sv_5", -0.002903 AS "sv_6", -0.002592 AS "sv_7", 0.070207 AS "sv_8", 0.135612 AS "sv_9"
   ) AS "Values"
 )
,"Kernel_DotProd" AS
 ( SELECT
