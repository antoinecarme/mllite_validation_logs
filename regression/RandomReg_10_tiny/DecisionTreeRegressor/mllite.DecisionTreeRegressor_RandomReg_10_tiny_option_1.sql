...
"DT_node_lookup" AS 
 (SELECT
    ...
    CASE WHEN (model_input."X_9" <= -1.583338) THEN 1 ELSE CASE WHEN (model_input."X_7" <= -1.543582) THEN CASE WHEN (model_input."X_9" <= -0.950757) THEN 15 ELSE 16 END ELSE CASE WHEN (model_input."X_0" <= 1.941732) THEN CASE WHEN (model_input."X_5" <= -1.549785) THEN CASE WHEN (model_input."X_5" <= -1.846437) THEN CASE WHEN (model_input."X_4" <= 0.473548) THEN 19 ELSE 20 END ELSE 14 END ELSE CASE WHEN (model_input."X_7" <= -0.005867) THEN CASE WHEN (model_input."X_6" <= -0.400839) THEN 17 ELSE 18 END ELSE CASE WHEN (model_input."X_9" <= 0.116520) THEN 11 ELSE 12 END END END ELSE 6 END END END AS node_id
  FROM model_input
 ),
"DT_node_data" AS 
 (SELECT
  ...
  FROM (
    ...
    UNION ALL
    SELECT 20 AS nid, 49.318077 AS "E"
  ) AS "Values"
 ),
"DT_output" AS 
 (SELECT
