...
,"SV_data" AS
 ( SELECT 
  ...
  FROM
  (
     SELECT 0 AS "sv_idx", 1.248515 AS "coeff", 0.544738 AS "sv_0", 0.515912 AS "sv_1", 0.990435 AS "sv_2", 0.255145 AS "sv_3", 0.143953 AS "sv_4", 0.332351 AS "sv_5", 0.868622 AS "sv_6", 0.041089 AS "sv_7", 0.898018 AS "sv_8", 0.377159 AS "sv_9"
     UNION ALL
     SELECT 1 AS "sv_idx", 1.209557 AS "coeff", 0.783459 AS "sv_0", 0.095321 AS "sv_1", 0.135945 AS "sv_2", 0.858711 AS "sv_3", 0.240785 AS "sv_4", 0.083671 AS "sv_5", 0.052374 AS "sv_6", 0.422766 AS "sv_7", 0.019766 AS "sv_8", 0.833486 AS "sv_9"
     UNION ALL
     ...
     UNION ALL
     SELECT 7 AS "sv_idx", 1.328962 AS "coeff", 0.825366 AS "sv_0", 0.284076 AS "sv_1", 0.971058 AS "sv_2", 0.191878 AS "sv_3", 0.387555 AS "sv_4", 0.062500 AS "sv_5", 0.206877 AS "sv_6", 0.900471 AS "sv_7", 0.780397 AS "sv_8", 0.355315 AS "sv_9"
     UNION ALL
     ...
     UNION ALL
     SELECT 10 AS "sv_idx", 0.212965 AS "coeff", 0.287599 AS "sv_0", 0.939261 AS "sv_1", 0.380885 AS "sv_2", 0.731889 AS "sv_3", 0.052941 AS "sv_4", 0.942998 AS "sv_5", 0.527849 AS "sv_6", 0.812585 AS "sv_7", 0.329620 AS "sv_8", 0.003549 AS "sv_9"
     UNION ALL
