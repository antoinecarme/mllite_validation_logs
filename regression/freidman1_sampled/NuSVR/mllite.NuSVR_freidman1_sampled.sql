...
,"SV_data" AS
 ( SELECT 
  ...
  (
     ...
     UNION ALL
     SELECT 1 AS "sv_idx", 1.000000 AS "coeff", 0.226051 AS "sv_0", 0.939732 AS "sv_1", 0.731124 AS "sv_2", 0.837456 AS "sv_3", 0.782448 AS "sv_4", 0.352927 AS "sv_5", 0.183212 AS "sv_6", 0.843453 AS "sv_7", 0.185038 AS "sv_8", 0.248943 AS "sv_9"
     UNION ALL
 ...
 ( SELECT
   ...
   FROM
    (SELECT
      ...
      sum(CAST(full_join_data_sv.dot_prod AS FLOAT)) - -14.781811 AS dot_product
     FROM
       (SELECT
