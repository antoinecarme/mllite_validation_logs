...
"DT_node_lookup" AS 
 (SELECT
    t."index" AS "index",
    COALESCE( t1."Leaf_4", t1."Leaf_7", t1."Leaf_8", t1."Leaf_11", t1."Leaf_13", t1."Leaf_14", t1."Leaf_16", t1."Leaf_19", t1."Leaf_20", t1."Leaf_21", t1."Leaf_24", t1."Leaf_26", t1."Leaf_27", t1."Leaf_29", t1."Leaf_31", t1."Leaf_32", t1."Leaf_33", t1."Leaf_36", t1."Leaf_37", t1."Leaf_39", t1."Leaf_40" ) AS node_id
  FROM
    "model_input" AS t
    LEFT OUTER JOIN
   (SELECT
      ...
      CASE WHEN((t."X_8" <= 0.191088) AND (t."X_3" <= 0.761311) AND (t."X_6" <= 1.535481) AND (t."X_0" > -1.119714) AND (t."X_3" > -1.509442) AND (t."X_4" <= 0.776090) AND (t."X_8" > -0.256948)) THEN 26 ELSE NULL END AS "Leaf_26",
      CASE WHEN((t."X_8" <= 0.191088) AND (t."X_3" <= 0.761311) AND (t."X_6" <= 1.535481) AND (t."X_0" > -1.119714) AND (t."X_3" > -1.509442) AND (t."X_4" <= 0.776090) AND (t."X_8" <= -0.256948) AND (t."X_3" <= -0.639380)) THEN 27 ELSE NULL END AS "Leaf_27",
      CASE WHEN((t."X_8" <= 0.191088) AND (t."X_3" <= 0.761311) AND (t."X_6" <= 1.535481) AND (t."X_0" > -1.119714) AND (t."X_3" > -1.509442) AND (t."X_4" <= 0.776090) AND (t."X_8" <= -0.256948) AND (t."X_3" > -0.639380) AND (t."X_4" <= -1.177200)) THEN 29 ELSE NULL END AS "Leaf_29",
      CASE WHEN((t."X_8" <= 0.191088) AND (t."X_3" <= 0.761311) AND (t."X_6" <= 1.535481) AND (t."X_0" > -1.119714) AND (t."X_3" > -1.509442) AND (t."X_4" <= 0.776090) AND (t."X_8" <= -0.256948) AND (t."X_3" > -0.639380) AND (t."X_4" > -1.177200) AND (t."X_0" <= -0.215499)) THEN 31 ELSE NULL END AS "Leaf_31",
      CASE WHEN((t."X_8" <= 0.191088) AND (t."X_3" <= 0.761311) AND (t."X_6" <= 1.535481) AND (t."X_0" > -1.119714) AND (t."X_3" > -1.509442) AND (t."X_4" <= 0.776090) AND (t."X_8" <= -0.256948) AND (t."X_3" > -0.639380) AND (t."X_4" > -1.177200) AND (t."X_0" > -0.215499)) THEN 32 ELSE NULL END AS "Leaf_32",
      CASE WHEN((t."X_8" > 0.191088) AND (t."X_3" <= 1.240127) AND (t."X_7" > -1.009942) AND (t."X_3" <= -1.923941)) THEN 33 ELSE NULL END AS "Leaf_33",
      CASE WHEN((t."X_8" > 0.191088) AND (t."X_3" <= 1.240127) AND (t."X_7" > -1.009942) AND (t."X_3" > -1.923941) AND (t."X_2" > 1.671657)) THEN 36 ELSE NULL END AS "Leaf_36",
      CASE WHEN((t."X_8" > 0.191088) AND (t."X_3" <= 1.240127) AND (t."X_7" > -1.009942) AND (t."X_3" > -1.923941) AND (t."X_2" <= 1.671657) AND (t."X_9" <= 1.194430)) THEN 37 ELSE NULL END AS "Leaf_37",
      CASE WHEN((t."X_8" > 0.191088) AND (t."X_3" <= 1.240127) AND (t."X_7" > -1.009942) AND (t."X_3" > -1.923941) AND (t."X_2" <= 1.671657) AND (t."X_9" > 1.194430) AND (t."X_0" <= -0.473842)) THEN 39 ELSE NULL END AS "Leaf_39",
      CASE WHEN((t."X_8" > 0.191088) AND (t."X_3" <= 1.240127) AND (t."X_7" > -1.009942) AND (t."X_3" > -1.923941) AND (t."X_2" <= 1.671657) AND (t."X_9" > 1.194430) AND (t."X_0" > -0.473842)) THEN 40 ELSE NULL END AS "Leaf_40"
...
"DT_node_data" AS 
 (SELECT
  ...
  FROM (
    ...
    UNION ALL
    SELECT 25 AS nid,  0.333333 AS "P_0", 0.166667 AS "P_1", 0.166667 AS "P_2", 0.333333 AS "P_3", 0 AS "D", 0.333333 AS "DP"
    UNION ALL
    ...
    UNION ALL
    SELECT 30 AS nid,  0.000000 AS "P_0", 0.333333 AS "P_1", 0.000000 AS "P_2", 0.666667 AS "P_3", 3 AS "D", 0.666667 AS "DP"
    UNION ALL
    ...
    UNION ALL
    SELECT 34 AS nid,  0.000000 AS "P_0", 0.894737 AS "P_1", 0.052632 AS "P_2", 0.052632 AS "P_3", 1 AS "D", 0.894737 AS "DP"
    UNION ALL
    SELECT 35 AS nid,  0.000000 AS "P_0", 0.944444 AS "P_1", 0.055556 AS "P_2", 0.000000 AS "P_3", 1 AS "D", 0.944444 AS "DP"
    UNION ALL
    ...
    UNION ALL
    SELECT 38 AS nid,  0.000000 AS "P_0", 0.500000 AS "P_1", 0.500000 AS "P_2", 0.000000 AS "P_3", 1 AS "D", 0.500000 AS "DP"
    UNION ALL
