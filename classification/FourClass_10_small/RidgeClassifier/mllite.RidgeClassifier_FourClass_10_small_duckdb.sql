...
model_scores_cte AS 
 (SELECT t."index" AS "index",
   ...
   -0.334821 + 0.079887 * t."X_0" + 0.028573 * t."X_1" + 0.016051 * t."X_2" + -0.020338 * t."X_3" + -0.053088 * t."X_4" + -0.093691 * t."X_5" + -0.005591 * t."X_6" + 0.296311 * t."X_7" + 0.173444 * t."X_8" + 0.046081 * t."X_9" AS "Score_1",
   CAST(NULL AS FLOAT) AS "Proba_1",
   CAST(NULL AS FLOAT) AS "LogProba_1",
   -0.576385 + 0.061993 * t."X_0" + 0.009899 * t."X_1" + -0.072956 * t."X_2" + -0.151344 * t."X_3" + 0.002321 * t."X_4" + -0.041556 * t."X_5" + 0.037707 * t."X_6" + -0.012812 * t."X_7" + -0.185290 * t."X_8" + -0.106759 * t."X_9" AS "Score_2",
   CAST(NULL AS FLOAT) AS "Proba_2",
   CAST(NULL AS FLOAT) AS "LogProba_2",
   -0.643771 + -0.055581 * t."X_0" + -0.014532 * t."X_1" + -0.018658 * t."X_2" + 0.059988 * t."X_3" + 0.037180 * t."X_4" + 0.199434 * t."X_5" + -0.026797 * t."X_6" + -0.136824 * t."X_7" + 0.008408 * t."X_8" + 0.105019 * t."X_9" AS "Score_3",
