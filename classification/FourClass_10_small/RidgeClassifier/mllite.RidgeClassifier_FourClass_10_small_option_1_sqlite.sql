...
model_scores_cte AS 
 (SELECT t."index" AS "index",
   ...
   -0.333723 + 0.082042 * t."X_0" + 0.026467 * t."X_1" + 0.017055 * t."X_2" + -0.021515 * t."X_3" + -0.053963 * t."X_4" + -0.096309 * t."X_5" + -0.006036 * t."X_6" + 0.302685 * t."X_7" + 0.176253 * t."X_8" + 0.049556 * t."X_9" AS "Score_1",
   CAST(NULL AS FLOAT) AS "Proba_1",
   CAST(NULL AS FLOAT) AS "LogProba_1",
   -0.577581 + 0.063162 * t."X_0" + 0.008796 * t."X_1" + -0.074449 * t."X_2" + -0.154844 * t."X_3" + 0.002084 * t."X_4" + -0.041886 * t."X_5" + 0.037052 * t."X_6" + -0.012974 * t."X_7" + -0.188436 * t."X_8" + -0.108870 * t."X_9" AS "Score_2",
   CAST(NULL AS FLOAT) AS "Proba_2",
   CAST(NULL AS FLOAT) AS "LogProba_2",
   -0.644906 + -0.056636 * t."X_0" + -0.013205 * t."X_1" + -0.019280 * t."X_2" + 0.061730 * t."X_3" + 0.037911 * t."X_4" + 0.203091 * t."X_5" + -0.026917 * t."X_6" + -0.139775 * t."X_7" + 0.008297 * t."X_8" + 0.105752 * t."X_9" AS "Score_3",
