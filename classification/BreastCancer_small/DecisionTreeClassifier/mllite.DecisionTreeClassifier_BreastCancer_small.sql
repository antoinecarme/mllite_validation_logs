 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      ...
      CASE WHEN((t."X_27" <= 0.143600) AND (t."X_21" > 29.180000) AND (t."X_23" <= 661.400024)) THEN 5 ELSE NULL END AS Leaf_5,
      CASE WHEN((t."X_27" <= 0.143600) AND (t."X_21" > 29.180000) AND (t."X_23" > 661.400024)) THEN 6 ELSE NULL END AS Leaf_6,
      CASE WHEN((t."X_27" <= 0.143600) AND (t."X_21" <= 29.180000) AND (t."X_27" <= 0.137000)) THEN 7 ELSE NULL END AS Leaf_7,
      CASE WHEN((t."X_27" <= 0.143600) AND (t."X_21" <= 29.180000) AND (t."X_27" > 0.137000) AND (t."X_6" <= 0.089945)) THEN 9 ELSE NULL END AS Leaf_9,
      CASE WHEN((t."X_27" <= 0.143600) AND (t."X_21" <= 29.180000) AND (t."X_27" > 0.137000) AND (t."X_6" > 0.089945)) THEN 10 ELSE NULL END AS Leaf_10
    FROM model_input t
    ) AS t1
    ON(t."index" == t1."index")
 ),
"DT_node_data" AS 
 (SELECT
  ...
  FROM (
    ...
    UNION ALL
    SELECT 1 AS nid,  0.108108 AS "P_0", 0.891892 AS "P_1", 1 AS "D", 0.891892 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  0.030303 AS "P_0", 0.969697 AS "P_1", 1 AS "D", 0.969697 AS "DP"
    UNION ALL
