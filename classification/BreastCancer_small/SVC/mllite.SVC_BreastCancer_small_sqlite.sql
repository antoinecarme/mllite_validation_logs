...
"ClassProblems" AS
 ( SELECT
   ...
   (
     ...
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 9 AS "sv_idx", 0.719078 AS "Coeff"
     UNION ALL
     ...
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 14 AS "sv_idx", 0.509455 AS "Coeff"
     UNION ALL
     ...
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 25 AS "sv_idx", 0.719078 AS "Coeff"
     UNION ALL
     ...
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 30 AS "sv_idx", 0.509455 AS "Coeff"
     UNION ALL
...
"SV_Rho" AS
 ( SELECT
   ...
   FROM
   (
     SELECT 0 AS "prob_idx", -0.313842 AS "rho", -2.433387 AS "probA", -0.257332 AS "probB"
   ) AS t
  ),
"Competition" AS
( SELECT 
