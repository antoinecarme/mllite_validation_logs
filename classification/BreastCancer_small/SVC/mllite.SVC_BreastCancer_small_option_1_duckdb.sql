...
"ClassProblems" AS
 ( SELECT
   ...
   (
     ...
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 9 AS "sv_idx", 0.014617 AS "Coeff"
     UNION ALL
     ...
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 13 AS "sv_idx", 0.580546 AS "Coeff"
     UNION ALL
     ...
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 24 AS "sv_idx", 0.014617 AS "Coeff"
     UNION ALL
     ...
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 28 AS "sv_idx", 0.580546 AS "Coeff"
   ) AS t
  ),
"SV_Rho" AS
 ( SELECT
   ...
   FROM
   (
     SELECT 0 AS "prob_idx", -0.269344 AS "rho", -2.151857 AS "probA", -0.049117 AS "probB"
   ) AS t
  ),
"Competition" AS
( SELECT 
