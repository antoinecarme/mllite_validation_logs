...
model_scores_cte AS 
 (SELECT t."index" AS "index",
   ...
   0.5 * ( 576.569092 + -17.053410 * t."X_0" + 0.000000 * t."X_1" + -0.002656 * t."X_2" + 0.000000 * t."X_3" + -3.340088 * t."X_4" + 0.000000 * t."X_5" + 0.000000 * t."X_6" + 0.000000 * t."X_7" + 0.000000 * t."X_8" + 0.000000 * t."X_9" + 2.691264 * t."X_10" + 5.022571 * t."X_11" + -3.528587 * t."X_12" + 0.000000 * t."X_13" ) AS "Score_1",
