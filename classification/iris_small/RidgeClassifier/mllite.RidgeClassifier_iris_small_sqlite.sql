...
model_scores_cte AS 
 (SELECT t."index" AS "index",
   -0.430242 + 0.015209 * t."X_0" + 0.532474 * t."X_1" + -0.369107 * t."X_2" + -0.186778 * t."X_3" AS "Score_0",
   CAST(NULL AS FLOAT) AS "Proba_0",
   CAST(NULL AS FLOAT) AS "LogProba_0",
   1.161481 + 0.194343 * t."X_0" + -0.849024 * t."X_1" + 0.144426 * t."X_2" + -0.563945 * t."X_3" AS "Score_1",
   CAST(NULL AS FLOAT) AS "Proba_1",
   CAST(NULL AS FLOAT) AS "LogProba_1",
   -1.731240 + -0.209552 * t."X_0" + 0.316551 * t."X_1" + 0.224681 * t."X_2" + 0.750721 * t."X_3" AS "Score_2",
