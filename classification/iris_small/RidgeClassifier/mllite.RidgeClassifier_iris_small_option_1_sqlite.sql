...
model_scores_cte AS 
 (SELECT t."index" AS "index",
   -0.589837 + 0.124797 * t."X_0" + 0.462737 * t."X_1" + -0.486750 * t."X_2" + -0.043288 * t."X_3" AS "Score_0",
   CAST(NULL AS FLOAT) AS "Proba_0",
   CAST(NULL AS FLOAT) AS "LogProba_0",
   1.178981 + 0.168951 * t."X_0" + -0.842424 * t."X_1" + 0.228782 * t."X_2" + -0.732506 * t."X_3" AS "Score_1",
   CAST(NULL AS FLOAT) AS "Proba_1",
   CAST(NULL AS FLOAT) AS "LogProba_1",
   -1.589140 + -0.293749 * t."X_0" + 0.379687 * t."X_1" + 0.257969 * t."X_2" + 0.775793 * t."X_3" AS "Score_2",
