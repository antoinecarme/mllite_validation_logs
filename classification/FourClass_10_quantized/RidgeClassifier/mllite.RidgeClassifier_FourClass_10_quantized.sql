...
model_scores_cte AS 
 (SELECT model_input."index" AS "index",
   ...
   -1.796600 + 0.044314 * X_0 + 0.033444 * X_1 + 0.001439 * X_2 + 0.010946 * X_3 + 0.007176 * X_4 + -0.001089 * X_5 + -0.055737 * X_6 + 0.161206 * X_7 + 0.075049 * X_8 + 0.010744 * X_9 AS "Score_1", CAST(NULL AS FLOAT) AS "Proba_1", CAST(NULL AS FLOAT) AS "LogProba_1",
   -0.473390 + 0.092531 * X_0 + 0.098774 * X_1 + -0.002830 * X_2 + -0.021888 * X_3 + -0.015227 * X_4 + -0.003229 * X_5 + -0.021448 * X_6 + 0.026299 * X_7 + -0.155355 * X_8 + -0.001073 * X_9 AS "Score_2", CAST(NULL AS FLOAT) AS "Proba_2", CAST(NULL AS FLOAT) AS "LogProba_2",
   -1.506894 + 0.076140 * X_0 + 0.158153 * X_1 + -0.005109 * X_2 + 0.145066 * X_3 + 0.013212 * X_4 + 0.015225 * X_5 + -0.040110 * X_6 + -0.093103 * X_7 + -0.043955 * X_8 + -0.002077 * X_9 AS "Score_3", CAST(NULL AS FLOAT) AS "Proba_3", CAST(NULL AS FLOAT) AS "LogProba_3"
  FROM model_input
 )
,
