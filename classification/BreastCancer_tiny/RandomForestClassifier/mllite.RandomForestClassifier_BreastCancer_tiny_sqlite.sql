...
"DT_node_lookup_0" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_6" <= 0.120515)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_6" > 0.120515)) THEN 2 ELSE NULL END AS "Leaf_2"
...
"DT_node_lookup_1" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_23" <= 745.250000)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_23" > 745.250000)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_2" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_16" <= 0.031130)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_16" > 0.031130)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_3" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_27" <= 0.128845)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_27" > 0.128845)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_4" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_20" <= 17.090000)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_20" > 17.090000)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_5" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_16" <= 0.030755)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_16" > 0.030755)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_6" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_5" <= 0.132200)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_5" > 0.132200) AND (t."X_29" <= 0.105150)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_5" > 0.132200) AND (t."X_29" > 0.105150)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_7" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_0" <= 13.620000)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_0" > 13.620000)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_8" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_27" <= 0.112930)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_27" > 0.112930)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_9" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_2" <= 96.134995)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_2" > 96.134995)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_10" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_2" <= 98.535004)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_2" > 98.535004)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_13" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_27" <= 0.111000)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_27" > 0.111000)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_14" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_6" <= 0.122730)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_6" > 0.122730)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_15" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_0" <= 14.764999)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_0" > 14.764999)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_16" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_25" <= 0.267800)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_25" > 0.267800)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_17" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_26" <= 0.289150)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_26" > 0.289150)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_19" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_6" <= 0.125030)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_6" > 0.125030)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_20" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_27" <= 0.140545)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_27" > 0.140545)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_22" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_25" <= 0.267850)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_25" > 0.267850)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_23" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_17" <= 0.014720)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_17" > 0.014720)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_24" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_17" <= 0.009518)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_17" > 0.009518)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_25" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_22" <= 114.000000)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_22" > 114.000000)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_26" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_7" <= 0.060470)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_7" > 0.060470)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_27" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_3" <= 683.550049)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_3" > 683.550049)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_28" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_3" <= 718.099976)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_3" > 718.099976)) THEN 2 ELSE NULL END AS "Leaf_2"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
