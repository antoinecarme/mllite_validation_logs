...
model_scores_cte AS 
 (SELECT model_input."index" AS "index",
   -1.838778 + 0.025835 * X_0 + 0.000000 * X_1 + 0.002276 * X_2 + 0.000000 * X_3 + 0.046985 * X_4 + 0.000000 * X_5 + 0.000000 * X_6 + 0.000000 * X_7 + 0.000000 * X_8 + 0.000000 * X_9 + 0.209869 * X_10 + 0.039601 * X_11 + 0.183518 * X_12 + 0.000000 * X_13 AS "Score_1", CAST(NULL AS FLOAT) AS "Proba_1", CAST(NULL AS FLOAT) AS "LogProba_1"
  FROM model_input
 )
,
