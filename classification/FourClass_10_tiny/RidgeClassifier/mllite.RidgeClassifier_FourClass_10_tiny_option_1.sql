...
model_scores_cte AS 
 (SELECT model_input."index" AS "index",
   -0.442135 + -0.154429 * X_0 + 0.015149 * X_1 + 0.104946 * X_2 + 0.076330 * X_3 + -0.066677 * X_4 + -0.186832 * X_5 + 0.103110 * X_6 + -0.171904 * X_7 + -0.206620 * X_8 + -0.019599 * X_9 AS "Score_0", CAST(NULL AS FLOAT) AS "Proba_0", CAST(NULL AS FLOAT) AS "LogProba_0",
   -0.668150 + -0.011216 * X_0 + 0.077046 * X_1 + -0.145877 * X_2 + -0.018421 * X_3 + -0.100731 * X_4 + 0.115675 * X_5 + 0.008068 * X_6 + 0.421474 * X_7 + 0.201976 * X_8 + 0.154531 * X_9 AS "Score_1", CAST(NULL AS FLOAT) AS "Proba_1", CAST(NULL AS FLOAT) AS "LogProba_1",
   0.737475 + 0.174692 * X_0 + -0.171246 * X_1 + -0.363852 * X_2 + 0.179531 * X_3 + 0.708414 * X_4 + -1.011025 * X_5 + 0.060251 * X_6 + 0.012783 * X_7 + 0.019254 * X_8 + -0.233526 * X_9 AS "Score_2", CAST(NULL AS FLOAT) AS "Proba_2", CAST(NULL AS FLOAT) AS "LogProba_2",
   -1.627377 + -0.008912 * X_0 + 0.079408 * X_1 + 0.404783 * X_2 + -0.237477 * X_3 + -0.541006 * X_4 + 1.082182 * X_5 + -0.171383 * X_6 + -0.262605 * X_7 + -0.014581 * X_8 + 0.098594 * X_9 AS "Score_3", CAST(NULL AS FLOAT) AS "Proba_3", CAST(NULL AS FLOAT) AS "LogProba_3"
  FROM model_input
 )
,
