...
model_scores_cte AS 
 (SELECT model_input."index" AS "index",
   ...
   -0.652669 + -0.019153 * X_0 + 0.075403 * X_1 + -0.137828 * X_2 + -0.013920 * X_3 + -0.104139 * X_4 + 0.107722 * X_5 + 0.009723 * X_6 + 0.393580 * X_7 + 0.186228 * X_8 + 0.132176 * X_9 AS "Score_1", CAST(NULL AS FLOAT) AS "Proba_1", CAST(NULL AS FLOAT) AS "LogProba_1",
   0.412964 + 0.157958 * X_0 + -0.125283 * X_1 + -0.228915 * X_2 + 0.078264 * X_3 + 0.560754 * X_4 + -0.731915 * X_5 + 0.044269 * X_6 + 0.008193 * X_7 + -0.030522 * X_8 + -0.233614 * X_9 AS "Score_2", CAST(NULL AS FLOAT) AS "Proba_2", CAST(NULL AS FLOAT) AS "LogProba_2",
   -1.286860 + -0.003933 * X_0 + 0.035169 * X_1 + 0.266642 * X_2 + -0.125041 * X_3 + -0.379927 * X_4 + 0.790948 * X_5 + -0.147882 * X_6 + -0.246321 * X_7 + 0.039298 * X_8 + 0.110588 * X_9 AS "Score_3", CAST(NULL AS FLOAT) AS "Proba_3", CAST(NULL AS FLOAT) AS "LogProba_3"
  FROM model_input
 )
,
