...
"DT_node_data_1" AS 
 (SELECT
    ...
    "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."P_3" AS "P_3"
  FROM (
    SELECT 0 AS nid,  0.375000 AS "P_0", 0.500000 AS "P_1", 0.500000 AS "P_2", 0.625000 AS "P_3"
  ) AS "Values")
,
"DT_output_1" AS 
 (SELECT
...
"DT_node_data_2" AS 
 (SELECT
    ...
    "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."P_3" AS "P_3"
  FROM (
    SELECT 0 AS nid,  0.750000 AS "P_0", 1.000000 AS "P_1", 1.000000 AS "P_2", 1.250000 AS "P_3"
  ) AS "Values")
,
"DT_output_2" AS 
 (SELECT
...
"DT_node_data_3" AS 
 (SELECT
    ...
    "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."P_3" AS "P_3"
  FROM (
    SELECT 0 AS nid,  1.500000 AS "P_0", 2.000000 AS "P_1", 2.000000 AS "P_2", 2.500000 AS "P_3"
  ) AS "Values")
,
"DT_output_3" AS 
 (SELECT
...
"DT_node_data_4" AS 
 (SELECT
    ...
    "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2", "Values"."P_3" AS "P_3"
  FROM (
    SELECT 0 AS nid,  3.000000 AS "P_0", 4.000000 AS "P_1", 4.000000 AS "P_2", 5.000000 AS "P_3"
  ) AS "Values")
,
"DT_output_4" AS 
 (SELECT
