...
"ClassProblems" AS
 ( SELECT
   ...
   (
     ...
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 6 AS "sv_idx", -0.251930 AS "Coeff"
     UNION ALL
     ...
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 10 AS "sv_idx", -0.251930 AS "Coeff"
     UNION ALL
     ...
     UNION ALL
     SELECT 2 AS "prob_idx", 0 AS "c_1", 3 AS "c_2", 14 AS "sv_idx", -0.251930 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 0 AS "c_1", 3 AS "c_2", 15 AS "sv_idx", -1.000000 AS "Coeff"
     UNION ALL
     SELECT 3 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 3 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 3 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 4 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 3 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 5 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 3 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 6 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 3 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 7 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 3 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 8 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 3 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 9 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 3 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 10 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 4 AS "prob_idx", 1 AS "c_1", 3 AS "c_2", 3 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 4 AS "prob_idx", 1 AS "c_1", 3 AS "c_2", 4 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 4 AS "prob_idx", 1 AS "c_1", 3 AS "c_2", 5 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 4 AS "prob_idx", 1 AS "c_1", 3 AS "c_2", 6 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 4 AS "prob_idx", 1 AS "c_1", 3 AS "c_2", 11 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 4 AS "prob_idx", 1 AS "c_1", 3 AS "c_2", 12 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 4 AS "prob_idx", 1 AS "c_1", 3 AS "c_2", 13 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 4 AS "prob_idx", 1 AS "c_1", 3 AS "c_2", 14 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 4 AS "prob_idx", 1 AS "c_1", 3 AS "c_2", 15 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 5 AS "prob_idx", 2 AS "c_1", 3 AS "c_2", 7 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 5 AS "prob_idx", 2 AS "c_1", 3 AS "c_2", 8 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 5 AS "prob_idx", 2 AS "c_1", 3 AS "c_2", 9 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 5 AS "prob_idx", 2 AS "c_1", 3 AS "c_2", 10 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 5 AS "prob_idx", 2 AS "c_1", 3 AS "c_2", 11 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 5 AS "prob_idx", 2 AS "c_1", 3 AS "c_2", 12 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 5 AS "prob_idx", 2 AS "c_1", 3 AS "c_2", 13 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 5 AS "prob_idx", 2 AS "c_1", 3 AS "c_2", 14 AS "sv_idx", 1.000000 AS "Coeff"
     UNION ALL
     SELECT 5 AS "prob_idx", 2 AS "c_1", 3 AS "c_2", 15 AS "sv_idx", 1.000000 AS "Coeff"
   ) AS t
  ),
"SV_Rho" AS
 ( SELECT
   ...
   FROM
   (
     SELECT 0 AS "prob_idx", 0.465296 AS "rho", 2.711208 AS "probA", 1.325466 AS "probB"
     UNION ALL
     SELECT 1 AS "prob_idx", 0.628257 AS "rho", 1.679533 AS "probA", 1.052925 AS "probB"
     UNION ALL
     SELECT 2 AS "prob_idx", 0.498370 AS "rho", 3.426831 AS "probA", 2.695331 AS "probB"
     UNION ALL
     SELECT 3 AS "prob_idx", -0.097796 AS "rho", 2.426913 AS "probA", -0.016565 AS "probB"
     UNION ALL
     SELECT 4 AS "prob_idx", 0.195279 AS "rho", 0.125302 AS "probA", 0.233480 AS "probB"
     UNION ALL
     SELECT 5 AS "prob_idx", 0.141720 AS "rho", 0.647735 AS "probA", 0.389135 AS "probB"
   ) AS t
  ),
"Competition" AS
( SELECT 
