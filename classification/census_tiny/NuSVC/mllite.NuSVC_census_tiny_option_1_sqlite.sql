...
"SV_data" AS
 ( SELECT 
  ...
  FROM
  (
     SELECT 0 AS "sv_idx", 4.000000 AS "sv_0", 0.000000 AS "sv_1", 175964.000000 AS "sv_2", 0.000000 AS "sv_3", 10.000000 AS "sv_4", 0.000000 AS "sv_5", 0.000000 AS "sv_6", 0.000000 AS "sv_7", 0.000000 AS "sv_8", 0.000000 AS "sv_9", 0.000000 AS "sv_10", 0.000000 AS "sv_11", 2.000000 AS "sv_12", 0.000000 AS "sv_13"
     UNION ALL
     ...
     UNION ALL
     SELECT 2 AS "sv_idx", 0.000000 AS "sv_0", 0.000000 AS "sv_1", 340543.000000 AS "sv_2", 0.000000 AS "sv_3", 13.000000 AS "sv_4", 0.000000 AS "sv_5", 0.000000 AS "sv_6", 0.000000 AS "sv_7", 0.000000 AS "sv_8", 0.000000 AS "sv_9", 0.000000 AS "sv_10", 0.000000 AS "sv_11", 2.000000 AS "sv_12", 0.000000 AS "sv_13"
     UNION ALL
     SELECT 3 AS "sv_idx", 2.000000 AS "sv_0", 0.000000 AS "sv_1", 188950.000000 AS "sv_2", 0.000000 AS "sv_3", 14.000000 AS "sv_4", 0.000000 AS "sv_5", 0.000000 AS "sv_6", 0.000000 AS "sv_7", 0.000000 AS "sv_8", 0.000000 AS "sv_9", 0.000000 AS "sv_10", 0.000000 AS "sv_11", 3.000000 AS "sv_12", 0.000000 AS "sv_13"
     UNION ALL
     SELECT 4 AS "sv_idx", 1.000000 AS "sv_0", 0.000000 AS "sv_1", 129707.000000 AS "sv_2", 0.000000 AS "sv_3", 13.000000 AS "sv_4", 0.000000 AS "sv_5", 0.000000 AS "sv_6", 0.000000 AS "sv_7", 0.000000 AS "sv_8", 0.000000 AS "sv_9", 4.000000 AS "sv_10", 0.000000 AS "sv_11", 1.000000 AS "sv_12", 0.000000 AS "sv_13"
   ) AS "Values"
 ),
"Kernel_RBF" AS
 ( SELECT
...
"ClassProblems" AS
 ( SELECT
   ...
   FROM
   (
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 0 AS "sv_idx", -6544.289551 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 1 AS "sv_idx", -82.038773 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 2 AS "sv_idx", -93.601326 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 3 AS "sv_idx", -6544.289551 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 4 AS "sv_idx", -82.038773 AS "Coeff"
   ) AS t
  ),
"SV_Rho" AS
 ( SELECT
   ...
   FROM
   (
     SELECT 0 AS "prob_idx", -0.830079 AS "rho", -0.000889 AS "probA", -0.746666 AS "probB"
   ) AS t
  ),
"Competition" AS
( SELECT 
