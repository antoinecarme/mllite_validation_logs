 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      ...
      CASE WHEN((t."X_27" <= 0.143600) AND (t."X_22" <= 106.400002)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_27" <= 0.143600) AND (t."X_22" > 106.400002) AND (t."X_19" > 0.002912)) THEN 6 ELSE NULL END AS "Leaf_6",
      CASE WHEN((t."X_27" <= 0.143600) AND (t."X_22" > 106.400002) AND (t."X_19" <= 0.002912) AND (t."X_1" <= 22.219999)) THEN 7 ELSE NULL END AS "Leaf_7",
      CASE WHEN((t."X_27" <= 0.143600) AND (t."X_22" > 106.400002) AND (t."X_19" <= 0.002912) AND (t."X_1" > 22.219999)) THEN 8 ELSE NULL END AS "Leaf_8"
...
"DT_node_data" AS 
 (SELECT
  ...
  FROM (
    ...
    UNION ALL
    SELECT 1 AS nid,  0.097561 AS "P_0", 0.902439 AS "P_1", 1 AS "D", 0.902439 AS "DP"
    UNION ALL
