...
"DT_node_data_1" AS 
 (SELECT
    ...
    "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1"
  FROM (
    SELECT 0 AS nid,  1.375000 AS "P_0", 0.625000 AS "P_1"
  ) AS "Values")
,
"DT_output_1" AS 
 (SELECT
...
"DT_node_data_2" AS 
 (SELECT
    ...
    "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1"
  FROM (
    SELECT 0 AS nid,  2.750000 AS "P_0", 1.250000 AS "P_1"
  ) AS "Values")
,
"DT_output_2" AS 
 (SELECT
...
"DT_node_data_3" AS 
 (SELECT
    ...
    "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1"
  FROM (
    SELECT 0 AS nid,  5.500000 AS "P_0", 2.500000 AS "P_1"
  ) AS "Values")
,
"DT_output_3" AS 
 (SELECT
...
"DT_node_data_4" AS 
 (SELECT
    ...
    "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1"
  FROM (
    SELECT 0 AS nid,  11.000000 AS "P_0", 5.000000 AS "P_1"
  ) AS "Values")
,
"DT_output_4" AS 
 (SELECT
