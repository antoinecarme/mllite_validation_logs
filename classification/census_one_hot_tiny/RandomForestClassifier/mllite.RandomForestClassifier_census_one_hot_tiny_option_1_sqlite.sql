...
"DT_node_lookup_1" AS 
 (SELECT
    t."index" AS "index",
    COALESCE( t1."Leaf_2", t1."Leaf_5", t1."Leaf_6", t1."Leaf_8", t1."Leaf_10", t1."Leaf_12", t1."Leaf_13", t1."Leaf_14" ) AS node_id
  FROM
    "model_input" AS t
    LEFT OUTER JOIN
   (SELECT
      ...
      CASE WHEN((t."X_45" <= 3.500000) AND (t."X_28" <= 0.500000) AND (t."X_15" <= 0.500000) AND (t."X_11" <= 0.500000) AND (t."X_4" <= 0.500000) AND (t."X_45" <= 2.500000)) THEN 13 ELSE NULL END AS "Leaf_13",
...
"DT_node_lookup_2" AS 
 (SELECT
    t."index" AS "index",
    COALESCE( t1."Leaf_2", t1."Leaf_3", t1."Leaf_6", t1."Leaf_9", t1."Leaf_10", t1."Leaf_11", t1."Leaf_13", t1."Leaf_14" ) AS node_id
  FROM
    "model_input" AS t
    LEFT OUTER JOIN
   (SELECT
      ...
      CASE WHEN((t."X_36" <= 0.500000) AND (t."X_42" > 0.500000) AND (t."X_43" <= 2.000000) AND (t."X_52" <= 0.500000) AND (t."X_45" > 1.500000) AND (t."X_45" <= 2.500000)) THEN 13 ELSE NULL END AS "Leaf_13",
