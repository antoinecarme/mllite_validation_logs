 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      ...
      CASE WHEN((t."X_18" > 0.500000) AND (t."X_5" > 0.500000)) THEN 4 ELSE NULL END AS "Leaf_4",
      CASE WHEN((t."X_18" > 0.500000) AND (t."X_5" <= 0.500000) AND (t."X_4" <= 0.500000)) THEN 5 ELSE NULL END AS "Leaf_5",
      CASE WHEN((t."X_18" > 0.500000) AND (t."X_5" <= 0.500000) AND (t."X_4" > 0.500000)) THEN 6 ELSE NULL END AS "Leaf_6"
