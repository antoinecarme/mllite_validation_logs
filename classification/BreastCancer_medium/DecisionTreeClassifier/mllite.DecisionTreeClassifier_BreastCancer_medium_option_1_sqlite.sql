...
"DT_node_lookup" AS 
 (SELECT
    t."index" AS "index",
    COALESCE( t1."Leaf_7", t1."Leaf_8", t1."Leaf_9", t1."Leaf_10", t1."Leaf_13", t1."Leaf_14", t1."Leaf_17", t1."Leaf_18", t1."Leaf_19", t1."Leaf_20", t1."Leaf_22", t1."Leaf_25", t1."Leaf_26", t1."Leaf_29", t1."Leaf_30", t1."Leaf_31", t1."Leaf_32" ) AS node_id
  FROM
    "model_input" AS t
    LEFT OUTER JOIN
   (SELECT
      ...
      CASE WHEN((t."X_22" <= 105.949997) AND (t."X_27" <= 0.158900) AND (t."X_10" <= 1.047550) AND (t."X_24" <= 0.178250) AND (t."X_21" > 30.145000) AND (t."X_20" <= 15.770000)) THEN 29 ELSE NULL END AS "Leaf_29",
      ...
      CASE WHEN((t."X_22" <= 105.949997) AND (t."X_27" <= 0.158900) AND (t."X_10" <= 1.047550) AND (t."X_24" <= 0.178250) AND (t."X_21" <= 30.145000) AND (t."X_13" <= 48.974998)) THEN 31 ELSE NULL END AS "Leaf_31",
      CASE WHEN((t."X_22" <= 105.949997) AND (t."X_27" <= 0.158900) AND (t."X_10" <= 1.047550) AND (t."X_24" <= 0.178250) AND (t."X_21" <= 30.145000) AND (t."X_13" > 48.974998)) THEN 32 ELSE NULL END AS "Leaf_32"
