...
"DT_node_data_1" AS 
 (SELECT
    ...
    "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2"
  FROM (
    SELECT 0 AS nid,  0.555555 AS "P_0", 0.888889 AS "P_1", 0.555555 AS "P_2"
  ) AS "Values")
,
"DT_output_1" AS 
 (SELECT
...
"DT_node_data_2" AS 
 (SELECT
    ...
    "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2"
  FROM (
    SELECT 0 AS nid,  1.111111 AS "P_0", 1.777778 AS "P_1", 1.111111 AS "P_2"
  ) AS "Values")
,
"DT_output_2" AS 
 (SELECT
...
"DT_node_data_3" AS 
 (SELECT
    ...
    "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2"
  FROM (
    SELECT 0 AS nid,  2.222222 AS "P_0", 3.555557 AS "P_1", 2.222222 AS "P_2"
  ) AS "Values")
,
"DT_output_3" AS 
 (SELECT
...
"DT_node_data_4" AS 
 (SELECT
    ...
    "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."P_2" AS "P_2"
  FROM (
    SELECT 0 AS nid,  4.444443 AS "P_0", 7.111114 AS "P_1", 4.444443 AS "P_2"
  ) AS "Values")
,
"DT_output_4" AS 
 (SELECT
