...
"SV_data" AS
 ( SELECT 
  ...
  (
     ...
     UNION ALL
     SELECT 8 AS "sv_idx", 6.200000 AS "sv_0", 2.900000 AS "sv_1", 4.300000 AS "sv_2", 1.300000 AS "sv_3"
     UNION ALL
     ...
     UNION ALL
     SELECT 11 AS "sv_idx", 6.800000 AS "sv_0", 3.200000 AS "sv_1", 5.900000 AS "sv_2", 2.300000 AS "sv_3"
     UNION ALL
     SELECT 12 AS "sv_idx", 6.700000 AS "sv_0", 3.300000 AS "sv_1", 5.700000 AS "sv_2", 2.100000 AS "sv_3"
   ) AS "Values"
 ),
"Kernel_RBF" AS
 ( SELECT
...
"ClassProblems" AS
 ( SELECT
   ...
   FROM
   (
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 0 AS "sv_idx", 1.170876 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 1 AS "sv_idx", 2.000000 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 2 AS "sv_idx", 1.170876 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 3 AS "sv_idx", 2.000000 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 5 AS "sv_idx", -0.397518 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 6 AS "sv_idx", -0.773358 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 0 AS "sv_idx", 0.141281 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 1 AS "sv_idx", 1.284144 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 9 AS "sv_idx", 1.170876 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 10 AS "sv_idx", 2.000000 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 12 AS "sv_idx", -0.397518 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 2 AS "sv_idx", 0.141281 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 3 AS "sv_idx", 1.284144 AS "Coeff"
     UNION ALL
     ...
     UNION ALL
     SELECT 2 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 8 AS "sv_idx", 0.684211 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 9 AS "sv_idx", 0.141281 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 10 AS "sv_idx", 1.284144 AS "Coeff"
     UNION ALL
...
"SV_Rho" AS
 ( SELECT
   ...
   FROM
   (
     SELECT 0 AS "prob_idx", -0.090057 AS "rho", -1.978797 AS "probA", 0.322553 AS "probB"
     UNION ALL
     SELECT 1 AS "prob_idx", 0.027411 AS "rho", -1.777841 AS "probA", 0.009580 AS "probB"
     UNION ALL
     SELECT 2 AS "prob_idx", -0.001722 AS "rho", -2.266994 AS "probA", 0.109777 AS "probB"
   ) AS t
  ),
"Competition" AS
( SELECT 
