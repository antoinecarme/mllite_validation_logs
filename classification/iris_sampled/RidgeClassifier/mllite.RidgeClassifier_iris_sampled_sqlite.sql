...
model_scores_cte AS 
 (SELECT t."index" AS "index",
   -1.957747 + -0.038377 * t."X_0" + 0.992181 * t."X_1" + -0.188127 * t."X_2" + -0.494877 * t."X_3" AS "Score_0",
   CAST(NULL AS FLOAT) AS "Proba_0",
   CAST(NULL AS FLOAT) AS "LogProba_0",
   4.843588 + -0.102291 * t."X_0" + -1.434411 * t."X_1" + -0.051340 * t."X_2" + 0.215633 * t."X_3" AS "Score_1",
   CAST(NULL AS FLOAT) AS "Proba_1",
   CAST(NULL AS FLOAT) AS "LogProba_1",
   -3.885842 + 0.140668 * t."X_0" + 0.442230 * t."X_1" + 0.239467 * t."X_2" + 0.279243 * t."X_3" AS "Score_2",
