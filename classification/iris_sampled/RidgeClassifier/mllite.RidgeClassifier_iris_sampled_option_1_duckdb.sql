...
model_scores_cte AS 
 (SELECT t."index" AS "index",
   -2.674155 + 0.137207 * t."X_0" + 0.975062 * t."X_1" + -0.224788 * t."X_2" + -0.594189 * t."X_3" AS "Score_0",
   CAST(NULL AS FLOAT) AS "Proba_0",
   CAST(NULL AS FLOAT) AS "LogProba_0",
   5.289789 + -0.012821 * t."X_0" + -1.650562 * t."X_1" + -0.224487 * t."X_2" + 0.505509 * t."X_3" AS "Score_1",
   CAST(NULL AS FLOAT) AS "Proba_1",
   CAST(NULL AS FLOAT) AS "LogProba_1",
   -3.615628 + -0.124389 * t."X_0" + 0.675502 * t."X_1" + 0.449278 * t."X_2" + 0.088676 * t."X_3" AS "Score_2",
