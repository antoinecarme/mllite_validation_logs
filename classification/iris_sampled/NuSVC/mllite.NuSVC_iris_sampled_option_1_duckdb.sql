...
"SV_data" AS
 ( SELECT 
  ...
  (
     ...
     UNION ALL
     SELECT 4 AS "sv_idx", 6.400000 AS "sv_0", 3.200000 AS "sv_1", 5.300000 AS "sv_2", 2.300000 AS "sv_3"
     UNION ALL
     SELECT 5 AS "sv_idx", 6.100000 AS "sv_0", 2.600000 AS "sv_1", 5.600000 AS "sv_2", 1.400000 AS "sv_3"
   ) AS "Values"
 ),
"Kernel_RBF" AS
 ( SELECT
...
"ClassProblems" AS
 ( SELECT
   ...
   FROM
   (
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 0 AS "sv_idx", 2.219941 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 1 AS "sv_idx", 2.492927 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 2 AS "sv_idx", 2.219941 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 3 AS "sv_idx", 2.492927 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 0 AS "sv_idx", 0.150763 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 1 AS "sv_idx", 1.274636 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 4 AS "sv_idx", 2.219941 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 5 AS "sv_idx", 2.492927 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 2 AS "sv_idx", 0.150763 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 3 AS "sv_idx", 1.274636 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 4 AS "sv_idx", 0.150763 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 5 AS "sv_idx", 1.274636 AS "Coeff"
   ) AS t
  ),
"SV_Rho" AS
 ( SELECT
   ...
   FROM
   (
     SELECT 0 AS "prob_idx", -0.032119 AS "rho", -1.666613 AS "probA", 0.111539 AS "probB"
     UNION ALL
     SELECT 1 AS "prob_idx", 0.027367 AS "rho", -1.778106 AS "probA", 0.009368 AS "probB"
     UNION ALL
     SELECT 2 AS "prob_idx", 0.390365 AS "rho", -1.212219 AS "probA", 0.093257 AS "probB"
   ) AS t
  ),
"Competition" AS
( SELECT 
