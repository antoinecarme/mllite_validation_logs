...
"ClassProblems" AS
 ( SELECT
   ...
   FROM
   (
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 0 AS "sv_idx", 0.864779 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 1 AS "sv_idx", 0.897017 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 2 AS "sv_idx", 0.344157 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 3 AS "sv_idx", 0.864779 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 4 AS "sv_idx", 0.897017 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 0 AS "sv_idx", 0.806281 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 1 AS "sv_idx", 1.030445 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 2 AS "sv_idx", 0.082239 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 5 AS "sv_idx", 0.864779 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 0 AS "c_1", 3 AS "c_2", 0 AS "sv_idx", 0.761090 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 0 AS "c_1", 3 AS "c_2", 1 AS "sv_idx", 0.910589 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 0 AS "c_1", 3 AS "c_2", 2 AS "sv_idx", 0.098242 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 0 AS "c_1", 3 AS "c_2", 6 AS "sv_idx", 0.864779 AS "Coeff"
     UNION ALL
     SELECT 3 AS "prob_idx", 0 AS "c_1", 4 AS "c_2", 0 AS "sv_idx", 0.679552 AS "Coeff"
     UNION ALL
     SELECT 3 AS "prob_idx", 0 AS "c_1", 4 AS "c_2", 1 AS "sv_idx", 1.302495 AS "Coeff"
     UNION ALL
     SELECT 3 AS "prob_idx", 0 AS "c_1", 4 AS "c_2", 2 AS "sv_idx", 0.017952 AS "Coeff"
     UNION ALL
     SELECT 3 AS "prob_idx", 0 AS "c_1", 4 AS "c_2", 7 AS "sv_idx", 0.864779 AS "Coeff"
     UNION ALL
     SELECT 4 AS "prob_idx", 0 AS "c_1", 5 AS "c_2", 0 AS "sv_idx", 0.767540 AS "Coeff"
     UNION ALL
     SELECT 4 AS "prob_idx", 0 AS "c_1", 5 AS "c_2", 1 AS "sv_idx", 1.225515 AS "Coeff"
     UNION ALL
     SELECT 4 AS "prob_idx", 0 AS "c_1", 5 AS "c_2", 2 AS "sv_idx", 0.139584 AS "Coeff"
     UNION ALL
     SELECT 4 AS "prob_idx", 0 AS "c_1", 5 AS "c_2", 8 AS "sv_idx", 0.864779 AS "Coeff"
     UNION ALL
     SELECT 4 AS "prob_idx", 0 AS "c_1", 5 AS "c_2", 9 AS "sv_idx", 0.897017 AS "Coeff"
     UNION ALL
     SELECT 4 AS "prob_idx", 0 AS "c_1", 5 AS "c_2", 10 AS "sv_idx", 0.344157 AS "Coeff"
     UNION ALL
     SELECT 5 AS "prob_idx", 0 AS "c_1", 6 AS "c_2", 0 AS "sv_idx", 1.000950 AS "Coeff"
     UNION ALL
     SELECT 5 AS "prob_idx", 0 AS "c_1", 6 AS "c_2", 1 AS "sv_idx", 1.654531 AS "Coeff"
     UNION ALL
     SELECT 5 AS "prob_idx", 0 AS "c_1", 6 AS "c_2", 2 AS "sv_idx", 0.260606 AS "Coeff"
     UNION ALL
     SELECT 5 AS "prob_idx", 0 AS "c_1", 6 AS "c_2", 11 AS "sv_idx", 0.864779 AS "Coeff"
     UNION ALL
     SELECT 5 AS "prob_idx", 0 AS "c_1", 6 AS "c_2", 12 AS "sv_idx", 0.897017 AS "Coeff"
     UNION ALL
     SELECT 6 AS "prob_idx", 0 AS "c_1", 7 AS "c_2", 0 AS "sv_idx", 2.000000 AS "Coeff"
     UNION ALL
     SELECT 6 AS "prob_idx", 0 AS "c_1", 7 AS "c_2", 1 AS "sv_idx", 1.336835 AS "Coeff"
     UNION ALL
     SELECT 6 AS "prob_idx", 0 AS "c_1", 7 AS "c_2", 2 AS "sv_idx", 0.357482 AS "Coeff"
     UNION ALL
     SELECT 6 AS "prob_idx", 0 AS "c_1", 7 AS "c_2", 13 AS "sv_idx", 0.864779 AS "Coeff"
     UNION ALL
     SELECT 6 AS "prob_idx", 0 AS "c_1", 7 AS "c_2", 14 AS "sv_idx", 0.897017 AS "Coeff"
     UNION ALL
     SELECT 6 AS "prob_idx", 0 AS "c_1", 7 AS "c_2", 15 AS "sv_idx", 0.344157 AS "Coeff"
     UNION ALL
     SELECT 7 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 3 AS "sv_idx", 0.806281 AS "Coeff"
     UNION ALL
     SELECT 7 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 4 AS "sv_idx", 1.030445 AS "Coeff"
     UNION ALL
     SELECT 7 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 5 AS "sv_idx", 0.806281 AS "Coeff"
     UNION ALL
     SELECT 8 AS "prob_idx", 1 AS "c_1", 3 AS "c_2", 3 AS "sv_idx", 0.761090 AS "Coeff"
     UNION ALL
     SELECT 8 AS "prob_idx", 1 AS "c_1", 3 AS "c_2", 4 AS "sv_idx", 0.910589 AS "Coeff"
     UNION ALL
     SELECT 8 AS "prob_idx", 1 AS "c_1", 3 AS "c_2", 6 AS "sv_idx", 0.806281 AS "Coeff"
     UNION ALL
     SELECT 9 AS "prob_idx", 1 AS "c_1", 4 AS "c_2", 3 AS "sv_idx", 0.679552 AS "Coeff"
     UNION ALL
     SELECT 9 AS "prob_idx", 1 AS "c_1", 4 AS "c_2", 4 AS "sv_idx", 1.302495 AS "Coeff"
     UNION ALL
     SELECT 9 AS "prob_idx", 1 AS "c_1", 4 AS "c_2", 7 AS "sv_idx", 0.806281 AS "Coeff"
     UNION ALL
     SELECT 10 AS "prob_idx", 1 AS "c_1", 5 AS "c_2", 3 AS "sv_idx", 0.767540 AS "Coeff"
     UNION ALL
     SELECT 10 AS "prob_idx", 1 AS "c_1", 5 AS "c_2", 4 AS "sv_idx", 1.225515 AS "Coeff"
     UNION ALL
     SELECT 10 AS "prob_idx", 1 AS "c_1", 5 AS "c_2", 8 AS "sv_idx", 0.806281 AS "Coeff"
     UNION ALL
     SELECT 10 AS "prob_idx", 1 AS "c_1", 5 AS "c_2", 9 AS "sv_idx", 1.030445 AS "Coeff"
     UNION ALL
     SELECT 10 AS "prob_idx", 1 AS "c_1", 5 AS "c_2", 10 AS "sv_idx", 0.082239 AS "Coeff"
     UNION ALL
     SELECT 11 AS "prob_idx", 1 AS "c_1", 6 AS "c_2", 3 AS "sv_idx", 1.000950 AS "Coeff"
     UNION ALL
     SELECT 11 AS "prob_idx", 1 AS "c_1", 6 AS "c_2", 4 AS "sv_idx", 1.654531 AS "Coeff"
     UNION ALL
     SELECT 11 AS "prob_idx", 1 AS "c_1", 6 AS "c_2", 11 AS "sv_idx", 0.806281 AS "Coeff"
     UNION ALL
     SELECT 11 AS "prob_idx", 1 AS "c_1", 6 AS "c_2", 12 AS "sv_idx", 1.030445 AS "Coeff"
     UNION ALL
     SELECT 12 AS "prob_idx", 1 AS "c_1", 7 AS "c_2", 3 AS "sv_idx", 2.000000 AS "Coeff"
     UNION ALL
     SELECT 12 AS "prob_idx", 1 AS "c_1", 7 AS "c_2", 4 AS "sv_idx", 1.336835 AS "Coeff"
     UNION ALL
     SELECT 12 AS "prob_idx", 1 AS "c_1", 7 AS "c_2", 13 AS "sv_idx", 0.806281 AS "Coeff"
     UNION ALL
     SELECT 12 AS "prob_idx", 1 AS "c_1", 7 AS "c_2", 14 AS "sv_idx", 1.030445 AS "Coeff"
     UNION ALL
     SELECT 12 AS "prob_idx", 1 AS "c_1", 7 AS "c_2", 15 AS "sv_idx", 0.082239 AS "Coeff"
     UNION ALL
     SELECT 13 AS "prob_idx", 2 AS "c_1", 3 AS "c_2", 5 AS "sv_idx", 0.761090 AS "Coeff"
     UNION ALL
     SELECT 13 AS "prob_idx", 2 AS "c_1", 3 AS "c_2", 6 AS "sv_idx", 0.761090 AS "Coeff"
     UNION ALL
     SELECT 14 AS "prob_idx", 2 AS "c_1", 4 AS "c_2", 5 AS "sv_idx", 0.679552 AS "Coeff"
     UNION ALL
     SELECT 14 AS "prob_idx", 2 AS "c_1", 4 AS "c_2", 7 AS "sv_idx", 0.761090 AS "Coeff"
     UNION ALL
     SELECT 15 AS "prob_idx", 2 AS "c_1", 5 AS "c_2", 5 AS "sv_idx", 0.767540 AS "Coeff"
     UNION ALL
     SELECT 15 AS "prob_idx", 2 AS "c_1", 5 AS "c_2", 8 AS "sv_idx", 0.761090 AS "Coeff"
     UNION ALL
     SELECT 15 AS "prob_idx", 2 AS "c_1", 5 AS "c_2", 9 AS "sv_idx", 0.910589 AS "Coeff"
     UNION ALL
     SELECT 15 AS "prob_idx", 2 AS "c_1", 5 AS "c_2", 10 AS "sv_idx", 0.098242 AS "Coeff"
     UNION ALL
     SELECT 16 AS "prob_idx", 2 AS "c_1", 6 AS "c_2", 5 AS "sv_idx", 1.000950 AS "Coeff"
     UNION ALL
     SELECT 16 AS "prob_idx", 2 AS "c_1", 6 AS "c_2", 11 AS "sv_idx", 0.761090 AS "Coeff"
     UNION ALL
     SELECT 16 AS "prob_idx", 2 AS "c_1", 6 AS "c_2", 12 AS "sv_idx", 0.910589 AS "Coeff"
     UNION ALL
     SELECT 17 AS "prob_idx", 2 AS "c_1", 7 AS "c_2", 5 AS "sv_idx", 2.000000 AS "Coeff"
     UNION ALL
     SELECT 17 AS "prob_idx", 2 AS "c_1", 7 AS "c_2", 13 AS "sv_idx", 0.761090 AS "Coeff"
     UNION ALL
     SELECT 17 AS "prob_idx", 2 AS "c_1", 7 AS "c_2", 14 AS "sv_idx", 0.910589 AS "Coeff"
     UNION ALL
     SELECT 17 AS "prob_idx", 2 AS "c_1", 7 AS "c_2", 15 AS "sv_idx", 0.098242 AS "Coeff"
     UNION ALL
     SELECT 18 AS "prob_idx", 3 AS "c_1", 4 AS "c_2", 6 AS "sv_idx", 0.679552 AS "Coeff"
     UNION ALL
     SELECT 18 AS "prob_idx", 3 AS "c_1", 4 AS "c_2", 7 AS "sv_idx", 0.679552 AS "Coeff"
     UNION ALL
     SELECT 19 AS "prob_idx", 3 AS "c_1", 5 AS "c_2", 6 AS "sv_idx", 0.767540 AS "Coeff"
     UNION ALL
     SELECT 19 AS "prob_idx", 3 AS "c_1", 5 AS "c_2", 8 AS "sv_idx", 0.679552 AS "Coeff"
     UNION ALL
     SELECT 19 AS "prob_idx", 3 AS "c_1", 5 AS "c_2", 9 AS "sv_idx", 1.302495 AS "Coeff"
     UNION ALL
     SELECT 19 AS "prob_idx", 3 AS "c_1", 5 AS "c_2", 10 AS "sv_idx", 0.017952 AS "Coeff"
     UNION ALL
     SELECT 20 AS "prob_idx", 3 AS "c_1", 6 AS "c_2", 6 AS "sv_idx", 1.000950 AS "Coeff"
     UNION ALL
     SELECT 20 AS "prob_idx", 3 AS "c_1", 6 AS "c_2", 11 AS "sv_idx", 0.679552 AS "Coeff"
     UNION ALL
     SELECT 20 AS "prob_idx", 3 AS "c_1", 6 AS "c_2", 12 AS "sv_idx", 1.302495 AS "Coeff"
     UNION ALL
     SELECT 21 AS "prob_idx", 3 AS "c_1", 7 AS "c_2", 6 AS "sv_idx", 2.000000 AS "Coeff"
     UNION ALL
     SELECT 21 AS "prob_idx", 3 AS "c_1", 7 AS "c_2", 13 AS "sv_idx", 0.679552 AS "Coeff"
     UNION ALL
     SELECT 21 AS "prob_idx", 3 AS "c_1", 7 AS "c_2", 14 AS "sv_idx", 1.302495 AS "Coeff"
     UNION ALL
     SELECT 21 AS "prob_idx", 3 AS "c_1", 7 AS "c_2", 15 AS "sv_idx", 0.017952 AS "Coeff"
     UNION ALL
     SELECT 22 AS "prob_idx", 4 AS "c_1", 5 AS "c_2", 7 AS "sv_idx", 0.767540 AS "Coeff"
     UNION ALL
     SELECT 22 AS "prob_idx", 4 AS "c_1", 5 AS "c_2", 8 AS "sv_idx", 0.767540 AS "Coeff"
     UNION ALL
     SELECT 22 AS "prob_idx", 4 AS "c_1", 5 AS "c_2", 9 AS "sv_idx", 1.225515 AS "Coeff"
     UNION ALL
     SELECT 22 AS "prob_idx", 4 AS "c_1", 5 AS "c_2", 10 AS "sv_idx", 0.139584 AS "Coeff"
     UNION ALL
     SELECT 23 AS "prob_idx", 4 AS "c_1", 6 AS "c_2", 7 AS "sv_idx", 1.000950 AS "Coeff"
     UNION ALL
     SELECT 23 AS "prob_idx", 4 AS "c_1", 6 AS "c_2", 11 AS "sv_idx", 0.767540 AS "Coeff"
     UNION ALL
     SELECT 23 AS "prob_idx", 4 AS "c_1", 6 AS "c_2", 12 AS "sv_idx", 1.225515 AS "Coeff"
     UNION ALL
     SELECT 24 AS "prob_idx", 4 AS "c_1", 7 AS "c_2", 7 AS "sv_idx", 2.000000 AS "Coeff"
     UNION ALL
     SELECT 24 AS "prob_idx", 4 AS "c_1", 7 AS "c_2", 13 AS "sv_idx", 0.767540 AS "Coeff"
     UNION ALL
     SELECT 24 AS "prob_idx", 4 AS "c_1", 7 AS "c_2", 14 AS "sv_idx", 1.225515 AS "Coeff"
     UNION ALL
     SELECT 24 AS "prob_idx", 4 AS "c_1", 7 AS "c_2", 15 AS "sv_idx", 0.139584 AS "Coeff"
     UNION ALL
     SELECT 25 AS "prob_idx", 5 AS "c_1", 6 AS "c_2", 8 AS "sv_idx", 1.000950 AS "Coeff"
     UNION ALL
     SELECT 25 AS "prob_idx", 5 AS "c_1", 6 AS "c_2", 9 AS "sv_idx", 1.654531 AS "Coeff"
     UNION ALL
     SELECT 25 AS "prob_idx", 5 AS "c_1", 6 AS "c_2", 10 AS "sv_idx", 0.260606 AS "Coeff"
     UNION ALL
     SELECT 25 AS "prob_idx", 5 AS "c_1", 6 AS "c_2", 11 AS "sv_idx", 1.000950 AS "Coeff"
     UNION ALL
     SELECT 25 AS "prob_idx", 5 AS "c_1", 6 AS "c_2", 12 AS "sv_idx", 1.654531 AS "Coeff"
     UNION ALL
     SELECT 26 AS "prob_idx", 5 AS "c_1", 7 AS "c_2", 8 AS "sv_idx", 2.000000 AS "Coeff"
     UNION ALL
     SELECT 26 AS "prob_idx", 5 AS "c_1", 7 AS "c_2", 9 AS "sv_idx", 1.336835 AS "Coeff"
     UNION ALL
     SELECT 26 AS "prob_idx", 5 AS "c_1", 7 AS "c_2", 10 AS "sv_idx", 0.357482 AS "Coeff"
     UNION ALL
     SELECT 26 AS "prob_idx", 5 AS "c_1", 7 AS "c_2", 13 AS "sv_idx", 1.000950 AS "Coeff"
     UNION ALL
     SELECT 26 AS "prob_idx", 5 AS "c_1", 7 AS "c_2", 14 AS "sv_idx", 1.654531 AS "Coeff"
     UNION ALL
     SELECT 26 AS "prob_idx", 5 AS "c_1", 7 AS "c_2", 15 AS "sv_idx", 0.260606 AS "Coeff"
     UNION ALL
     SELECT 27 AS "prob_idx", 6 AS "c_1", 7 AS "c_2", 11 AS "sv_idx", 2.000000 AS "Coeff"
     UNION ALL
     SELECT 27 AS "prob_idx", 6 AS "c_1", 7 AS "c_2", 12 AS "sv_idx", 1.336835 AS "Coeff"
     UNION ALL
     SELECT 27 AS "prob_idx", 6 AS "c_1", 7 AS "c_2", 13 AS "sv_idx", 2.000000 AS "Coeff"
     UNION ALL
     SELECT 27 AS "prob_idx", 6 AS "c_1", 7 AS "c_2", 14 AS "sv_idx", 1.336835 AS "Coeff"
     UNION ALL
     SELECT 27 AS "prob_idx", 6 AS "c_1", 7 AS "c_2", 15 AS "sv_idx", 0.357482 AS "Coeff"
   ) AS t
  ),
"SV_Rho" AS
 ( SELECT
   ...
   FROM
   (
     SELECT 0 AS "prob_idx", 0.139644 AS "rho", -3.492932 AS "probA", 1.097597 AS "probB"
     UNION ALL
     SELECT 1 AS "prob_idx", -0.187094 AS "rho", 3.099356 AS "probA", -3.295713 AS "probB"
     UNION ALL
     SELECT 2 AS "prob_idx", -0.174842 AS "rho", 3.473943 AS "probA", -3.645344 AS "probB"
     UNION ALL
     SELECT 3 AS "prob_idx", -0.183538 AS "rho", 2.660979 AS "probA", -2.934019 AS "probB"
     UNION ALL
     SELECT 4 AS "prob_idx", 0.011127 AS "rho", -1.855065 AS "probA", -0.041305 AS "probB"
     UNION ALL
     SELECT 5 AS "prob_idx", 0.117591 AS "rho", -4.075683 AS "probA", 1.300531 AS "probB"
     UNION ALL
     SELECT 6 AS "prob_idx", 0.014785 AS "rho", -1.784885 AS "probA", 0.080297 AS "probB"
     UNION ALL
     SELECT 7 AS "prob_idx", -0.286770 AS "rho", 2.009982 AS "probA", -1.316839 AS "probB"
     UNION ALL
     SELECT 8 AS "prob_idx", -0.333437 AS "rho", 1.782273 AS "probA", -1.093868 AS "probB"
     UNION ALL
     SELECT 9 AS "prob_idx", -0.296782 AS "rho", 1.951064 AS "probA", -1.260900 AS "probB"
     UNION ALL
     SELECT 10 AS "prob_idx", -0.135723 AS "rho", -3.144217 AS "probA", -1.022397 AS "probB"
     UNION ALL
     SELECT 11 AS "prob_idx", -0.097196 AS "rho", 3.511440 AS "probA", 0.260117 AS "probB"
     UNION ALL
     SELECT 12 AS "prob_idx", -0.092496 AS "rho", -3.338329 AS "probA", -0.988467 AS "probB"
     UNION ALL
     ...
     UNION ALL
     SELECT 15 AS "prob_idx", 0.266332 AS "rho", 2.400162 AS "probA", 2.734676 AS "probB"
     UNION ALL
     SELECT 16 AS "prob_idx", 0.257698 AS "rho", 2.061934 AS "probA", 1.421299 AS "probB"
     UNION ALL
     SELECT 17 AS "prob_idx", 0.208784 AS "rho", 1.782260 AS "probA", 2.191927 AS "probB"
     UNION ALL
     SELECT 18 AS "prob_idx", 0.000000 AS "rho", 0.693147 AS "probA", -0.000000 AS "probB"
     UNION ALL
     SELECT 19 AS "prob_idx", 0.312841 AS "rho", 2.647072 AS "probA", 2.975717 AS "probB"
     UNION ALL
     SELECT 20 AS "prob_idx", 0.787253 AS "rho", 1.340076 AS "probA", 0.648264 AS "probB"
     UNION ALL
     SELECT 21 AS "prob_idx", 0.284708 AS "rho", 1.863226 AS "probA", 2.212633 AS "probB"
     UNION ALL
     SELECT 22 AS "prob_idx", 0.174168 AS "rho", 2.754393 AS "probA", 3.107064 AS "probB"
     UNION ALL
     SELECT 23 AS "prob_idx", 0.258041 AS "rho", 2.157272 AS "probA", 1.475385 AS "probB"
     UNION ALL
     SELECT 24 AS "prob_idx", 0.192798 AS "rho", 2.420978 AS "probA", 2.764940 AS "probB"
     UNION ALL
     SELECT 25 AS "prob_idx", 0.040436 AS "rho", -5.783503 AS "probA", 2.453132 AS "probB"
     UNION ALL
     SELECT 26 AS "prob_idx", 0.062918 AS "rho", -1.819958 AS "probA", 0.168280 AS "probB"
     UNION ALL
     SELECT 27 AS "prob_idx", -0.072480 AS "rho", -0.455916 AS "probA", 0.127792 AS "probB"
   ) AS t
  ),
"Competition" AS
( SELECT 
