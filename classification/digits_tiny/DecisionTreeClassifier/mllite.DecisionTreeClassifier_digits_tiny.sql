...
"DT_node_lookup" AS 
 (SELECT
    t."index" AS "index",
    COALESCE( t1."Leaf_2", t1."Leaf_3", t1."Leaf_5", t1."Leaf_7", t1."Leaf_10", t1."Leaf_11", t1."Leaf_13", t1."Leaf_14" ) AS node_id
  FROM
    model_input t
    LEFT OUTER JOIN
   (SELECT
      ...
      CASE WHEN((t."X_29" <= 15.500000) AND (t."X_35" > 5.000000) AND (t."X_27" > 1.500000) AND (t."X_5" > 1.000000) AND (t."X_36" <= 15.500000) AND (t."X_45" > 7.000000) AND (t."X_58" <= 2.500000)) THEN 13 ELSE NULL END AS Leaf_13,
      CASE WHEN((t."X_29" <= 15.500000) AND (t."X_35" > 5.000000) AND (t."X_27" > 1.500000) AND (t."X_5" > 1.000000) AND (t."X_36" <= 15.500000) AND (t."X_45" > 7.000000) AND (t."X_58" > 2.500000)) THEN 14 ELSE NULL END AS Leaf_14
    FROM model_input t
    ) AS t1
    ON(t."index" == t1."index")
 ),
"DT_node_data" AS 
 (SELECT
  ...
  FROM (
    ...
    UNION ALL
    SELECT 13 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0.000000 AS "P_3", 1.000000 AS "P_4", 0.000000 AS "P_5", 0.000000 AS "P_6", 0.000000 AS "P_7", 4 AS "D", 1.000000 AS "DP"
    UNION ALL
