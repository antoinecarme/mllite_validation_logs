...
"DT_node_lookup" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_66" <= 2.123984) AND (t."X_25" > 0.211866)) THEN 4 ELSE NULL END AS "Leaf_4",
      CASE WHEN((t."X_66" <= 2.123984) AND (t."X_25" <= 0.211866) AND (t."X_75" <= 0.232310)) THEN 5 ELSE NULL END AS "Leaf_5",
      CASE WHEN((t."X_66" <= 2.123984) AND (t."X_25" <= 0.211866) AND (t."X_75" > 0.232310)) THEN 6 ELSE NULL END AS "Leaf_6",
      CASE WHEN((t."X_66" > 2.123984) AND (t."X_9" <= 1.812834)) THEN 7 ELSE NULL END AS "Leaf_7",
      CASE WHEN((t."X_66" > 2.123984) AND (t."X_9" > 1.812834)) THEN 8 ELSE NULL END AS "Leaf_8"
...
"DT_node_data" AS 
 (SELECT
  ...
  FROM (
    ...
    UNION ALL
    SELECT 1 AS nid,  0.000000 AS "P_0", 0.300000 AS "P_1", 0.400000 AS "P_2", 0.300000 AS "P_3", 2 AS "D", 0.400000 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.833333 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0.166667 AS "P_3", 0 AS "D", 0.833333 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  0.000000 AS "P_0", 0.500000 AS "P_1", 0.000000 AS "P_2", 0.500000 AS "P_3", 1 AS "D", 0.500000 AS "DP"
    UNION ALL
