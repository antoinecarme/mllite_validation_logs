...
model_scores_cte AS 
 (SELECT t."index" AS "index",
   ...
   0.5 * ( -0.013661 + 0.004375 * t."X_0" + 0.010529 * t."X_1" + 0.317227 * t."X_2" + 0.014715 * t."X_3" + -0.306301 * t."X_4" + 0.172503 * t."X_5" + 0.309628 * t."X_6" + -0.009627 * t."X_7" + 0.025265 * t."X_8" + -0.006674 * t."X_9" ) AS "Score_1",
