...
"Hidden_Layer_1_BA" AS
 ( SELECT t."index" as "index",
    0.192150 + -0.062877 * t."OUT_0"  + 0.049613 * t."OUT_1"  + 0.331685 * t."OUT_2"  + 0.392772 * t."OUT_3"  + 0.191696 * t."OUT_4"  + 0.157330 * t."OUT_5"  + -0.105943 * t."OUT_6"  + -0.053452 * t."OUT_7"  + -0.156097 * t."OUT_8"  + -0.308192 * t."OUT_9"  + -0.326248 * t."OUT_10"  + -0.292672 * t."OUT_11"  + 0.258098 * t."OUT_12"  + 0.228020 * t."OUT_13"  + 0.095024 * t."OUT_14"  + -0.385722 * t."OUT_15"  + -0.384193 * t."OUT_16"  + 0.388278 * t."OUT_17"  + -0.043354 * t."OUT_18"  + 0.161494 * t."OUT_19"  + 0.150795 * t."OUT_20"  + -0.400216 * t."OUT_21"  + -0.334332 * t."OUT_22"  + -0.006442 * t."OUT_23"  + 0.112499 * t."OUT_24"  + 0.149322 * t."OUT_25"  + 0.253629 * t."OUT_26"  + -0.202017 * t."OUT_27"  + 0.179651 * t."OUT_28"  + 0.041981 * t."OUT_29" AS "OUT_0",
...
"Hidden_Layer_2_BA" AS
 ( SELECT t."index" as "index",
    ...
    0.314154 + 0.116064 * t."OUT_0"  + -0.265616 * t."OUT_1"  + -0.625969 * t."OUT_2"  + 0.083580 * t."OUT_3" AS "OUT_2",
    -0.585498 + -0.284529 * t."OUT_0"  + -0.534516 * t."OUT_1"  + 0.136479 * t."OUT_2"  + -0.467854 * t."OUT_3" AS "OUT_3",
    0.265216 + 0.307188 * t."OUT_0"  + -0.540622 * t."OUT_1"  + -0.464325 * t."OUT_2"  + -0.116517 * t."OUT_3" AS "OUT_4",
    ...
    0.656902 + 0.542165 * t."OUT_0"  + -0.161909 * t."OUT_1"  + 0.245475 * t."OUT_2"  + -0.112664 * t."OUT_3" AS "OUT_7"
...
"Hidden_Layer_3_BA" AS
 ( SELECT t."index" as "index",
    0.318079 + -0.299766 * t."OUT_0"  + 0.136049 * t."OUT_1"  + 0.531662 * t."OUT_2"  + -0.013455 * t."OUT_3"  + 0.517290 * t."OUT_4"  + 0.085396 * t."OUT_5"  + -0.264320 * t."OUT_6"  + 0.011623 * t."OUT_7" AS "OUT_0",
    -0.297861 + 0.339618 * t."OUT_0"  + -0.365438 * t."OUT_1"  + 0.572828 * t."OUT_2"  + 0.598982 * t."OUT_3"  + 0.377184 * t."OUT_4"  + 0.534354 * t."OUT_5"  + -0.009806 * t."OUT_6"  + 0.270819 * t."OUT_7" AS "OUT_1",
    ...
    -0.584205 + 0.480827 * t."OUT_0"  + 0.303771 * t."OUT_1"  + 0.090214 * t."OUT_2"  + 0.268682 * t."OUT_3"  + -0.157303 * t."OUT_4"  + -0.358589 * t."OUT_5"  + 0.404701 * t."OUT_6"  + 0.331022 * t."OUT_7" AS "OUT_3",
    -0.332278 + -0.555063 * t."OUT_0"  + 0.018379 * t."OUT_1"  + 0.340022 * t."OUT_2"  + -0.460970 * t."OUT_3"  + 0.444131 * t."OUT_4"  + -0.368321 * t."OUT_5"  + 0.617728 * t."OUT_6"  + 0.032417 * t."OUT_7" AS "OUT_4",
    -0.413692 + 0.391634 * t."OUT_0"  + -0.284353 * t."OUT_1"  + 0.092188 * t."OUT_2"  + -0.088915 * t."OUT_3"  + -0.324037 * t."OUT_4"  + -0.341001 * t."OUT_5"  + 0.111382 * t."OUT_6"  + 0.406470 * t."OUT_7" AS "OUT_5"
...
"Output_Layer_BA" AS
 ( SELECT t."index" as "index",
    -0.198717 + 0.240226 * t."OUT_0"  + -0.149310 * t."OUT_1"  + -0.393289 * t."OUT_2"  + -0.792340 * t."OUT_3"  + 0.797121 * t."OUT_4"  + -0.371171 * t."OUT_5" AS "OUT_0"
