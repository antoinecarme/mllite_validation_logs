...
"DT_node_lookup" AS 
 (SELECT
    t."index" AS "index",
    COALESCE( t1."Leaf_9", t1."Leaf_10", t1."Leaf_11", t1."Leaf_12", t1."Leaf_14", t1."Leaf_15", t1."Leaf_16", t1."Leaf_19", t1."Leaf_20", t1."Leaf_21", t1."Leaf_23", t1."Leaf_26", t1."Leaf_27", t1."Leaf_28", t1."Leaf_31", t1."Leaf_33", t1."Leaf_34", t1."Leaf_37", t1."Leaf_38", t1."Leaf_39", t1."Leaf_40" ) AS node_id
  FROM
    "model_input" AS t
    LEFT OUTER JOIN
   (SELECT
      ...
      CASE WHEN((t."X_20" <= 16.795000) AND (t."X_27" <= 0.135800) AND (t."X_29" > 0.055125) AND (t."X_13" <= 38.605000) AND (t."X_14" > 0.003294) AND (t."X_21" > 33.269997)) THEN 40 ELSE NULL END AS "Leaf_40"
