...
model_scores_cte AS 
 (SELECT t."index" AS "index",
   ...
   -0.468939 + 0.083195 * t."X_0" + 0.035626 * t."X_1" + 0.001254 * t."X_2" + -0.049244 * t."X_3" + 0.027638 * t."X_4" + -0.010272 * t."X_5" + -0.011532 * t."X_6" + 0.242909 * t."X_7" + 0.184741 * t."X_8" + 0.040190 * t."X_9" AS "Score_1",
   CAST(NULL AS FLOAT) AS "Proba_1",
   CAST(NULL AS FLOAT) AS "LogProba_1",
   -0.549862 + 0.070768 * t."X_0" + 0.013034 * t."X_1" + -0.009926 * t."X_2" + -0.169575 * t."X_3" + -0.036088 * t."X_4" + -0.002820 * t."X_5" + 0.041183 * t."X_6" + 0.022116 * t."X_7" + -0.193116 * t."X_8" + -0.008953 * t."X_9" AS "Score_2",
   CAST(NULL AS FLOAT) AS "Proba_2",
   CAST(NULL AS FLOAT) AS "LogProba_2",
   -0.504380 + -0.073481 * t."X_0" + -0.025128 * t."X_1" + -0.010595 * t."X_2" + 0.098029 * t."X_3" + 0.031839 * t."X_4" + 0.037437 * t."X_5" + -0.021588 * t."X_6" + -0.147879 * t."X_7" + -0.004793 * t."X_8" + 0.003692 * t."X_9" AS "Score_3",
