...
model_scores_cte AS 
 (SELECT model_input."index" AS "index",
   -0.475859 + -0.064213 * X_0 + -0.016567 * X_1 + 0.027534 * X_2 + 0.109208 * X_3 + 0.018234 * X_4 + -0.055270 * X_5 + -0.023257 * X_6 + -0.109155 * X_7 + -0.007408 * X_8 + -0.025478 * X_9 AS "Score_0", CAST(NULL AS FLOAT) AS "Proba_0", CAST(NULL AS FLOAT) AS "LogProba_0",
   -0.449666 + 0.115950 * X_0 + 0.074218 * X_1 + -0.001267 * X_2 + -0.057166 * X_3 + 0.015171 * X_4 + 0.008684 * X_5 + 0.013560 * X_6 + 0.233182 * X_7 + 0.195240 * X_8 + 0.011723 * X_9 AS "Score_1", CAST(NULL AS FLOAT) AS "Proba_1", CAST(NULL AS FLOAT) AS "LogProba_1",
   -0.570475 + 0.049974 * X_0 + 0.003930 * X_1 + -0.005821 * X_2 + -0.164417 * X_3 + -0.068358 * X_4 + 0.002598 * X_5 + 0.048515 * X_6 + 0.014552 * X_7 + -0.179863 * X_8 + -0.017094 * X_9 AS "Score_2", CAST(NULL AS FLOAT) AS "Proba_2", CAST(NULL AS FLOAT) AS "LogProba_2",
   -0.503902 + -0.076111 * X_0 + -0.026072 * X_1 + -0.020445 * X_2 + 0.108793 * X_3 + 0.034953 * X_4 + 0.043989 * X_5 + -0.014795 * X_6 + -0.161781 * X_7 + 0.009635 * X_8 + 0.030849 * X_9 AS "Score_3", CAST(NULL AS FLOAT) AS "Proba_3", CAST(NULL AS FLOAT) AS "LogProba_3"
  FROM model_input
 )
,
