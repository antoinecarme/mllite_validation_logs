...
model_scores_cte AS 
 (SELECT t."index" AS "index",
   ...
   0.5 * ( -0.394584 + -0.394657 * t."X_0" + 0.296095 * t."X_1" + 0.233951 * t."X_2" + 0.161713 * t."X_3" + 0.048136 * t."X_4" + 0.177003 * t."X_5" + 0.228771 * t."X_6" + -0.188083 * t."X_7" + 0.366605 * t."X_8" + -0.048062 * t."X_9" ) AS "Score_1",
