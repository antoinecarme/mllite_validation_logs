...
model_scores_cte AS 
 (SELECT model_input."index" AS "index",
   6932.774414 + -224.609360 * X_0 + 0.000000 * X_1 + -0.029862 * X_2 + 0.000000 * X_3 + -84.369881 * X_4 + 0.000000 * X_5 + 0.000000 * X_6 + 0.000000 * X_7 + 0.000000 * X_8 + 0.000000 * X_9 + 88.484940 * X_10 + -90.602547 * X_11 + 82.159500 * X_12 + 0.000000 * X_13 AS "Score_1", CAST(NULL AS FLOAT) AS "Proba_1", CAST(NULL AS FLOAT) AS "LogProba_1"
  FROM model_input
 ),
