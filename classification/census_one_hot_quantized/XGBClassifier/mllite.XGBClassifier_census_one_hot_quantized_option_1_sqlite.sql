WITH model_input AS 
 (SELECT "ADS"."index" AS "index",
  ...
  FROM "census_one_hot_quantized" AS "ADS" 
 ),
"DT_node_lookup_0" AS 
 (SELECT
    t."index" AS "index",
    CASE WHEN (t."X_18" < 10.000000) THEN CASE WHEN (t."X_43" < 10.000000) THEN CASE WHEN (t."X_16" < 8.000000) THEN CASE WHEN (t."X_44" < 10.000000) THEN CASE WHEN (t."X_45" < 8.000000) THEN CASE WHEN (t."X_0" < 6.000000) THEN 47 ELSE 48 END ELSE CASE WHEN (t."X_0" < 6.000000) THEN 49 ELSE 50 END END ELSE CASE WHEN (t."X_42" < 10.000000) THEN CASE WHEN (t."X_30" < 10.000000) THEN 51 ELSE 52 END ELSE CASE WHEN (t."X_12" < 10.000000) THEN 53 ELSE 54 END END END ELSE CASE WHEN (t."X_0" < 6.000000) THEN CASE WHEN (t."X_45" < 8.000000) THEN CASE WHEN (t."X_44" < 10.000000) THEN 55 ELSE 56 END ELSE CASE WHEN (t."X_20" < 10.000000) THEN 57 ELSE 58 END END ELSE CASE WHEN (t."X_45" < 8.000000) THEN CASE WHEN (t."X_44" < 10.000000) THEN 59 ELSE 60 END ELSE CASE WHEN (t."X_15" < 10.000000) THEN 61 ELSE 62 END END END END ELSE CASE WHEN (t."X_0" < 3.000000) THEN CASE WHEN (t."X_32" < 10.000000) THEN 19 ELSE 20 END ELSE 10 END END ELSE CASE WHEN (t."X_16" < 8.000000) THEN CASE WHEN (t."X_16" < 3.000000) THEN CASE WHEN (t."X_45" < 8.000000) THEN CASE WHEN (t."X_0" < 6.000000) THEN 35 ELSE 36 END ELSE CASE WHEN (t."X_26" < 10.000000) THEN 37 ELSE 38 END END ELSE CASE WHEN (t."X_0" < 6.000000) THEN CASE WHEN (t."X_0" < 3.000000) THEN 39 ELSE 40 END ELSE CASE WHEN (t."X_45" < 5.000000) THEN 41 ELSE 42 END END END ELSE CASE WHEN (t."X_43" < 10.000000) THEN CASE WHEN (t."X_45" < 5.000000) THEN CASE WHEN (t."X_36" < 10.000000) THEN 43 ELSE 44 END ELSE CASE WHEN (t."X_0" < 3.000000) THEN 45 ELSE 46 END END ELSE 14 END END END AS node_id
  FROM model_input t
 )
,
"DT_node_data_0" AS 
...
"DT_node_lookup_1" AS 
 (SELECT
    t."index" AS "index",
    CASE WHEN (t."X_18" < 10.000000) THEN CASE WHEN (t."X_43" < 10.000000) THEN CASE WHEN (t."X_16" < 8.000000) THEN CASE WHEN (t."X_44" < 10.000000) THEN CASE WHEN (t."X_45" < 8.000000) THEN CASE WHEN (t."X_0" < 6.000000) THEN 47 ELSE 48 END ELSE CASE WHEN (t."X_0" < 6.000000) THEN 49 ELSE 50 END END ELSE CASE WHEN (t."X_8" < 8.000000) THEN CASE WHEN (t."X_26" < 10.000000) THEN 51 ELSE 52 END ELSE 32 END END ELSE CASE WHEN (t."X_0" < 6.000000) THEN CASE WHEN (t."X_45" < 8.000000) THEN CASE WHEN (t."X_0" < 3.000000) THEN 53 ELSE 54 END ELSE CASE WHEN (t."X_0" < 3.000000) THEN 55 ELSE 56 END END ELSE CASE WHEN (t."X_15" < 10.000000) THEN CASE WHEN (t."X_26" < 10.000000) THEN 57 ELSE 58 END ELSE CASE WHEN (t."X_45" < 5.000000) THEN 59 ELSE 60 END END END END ELSE CASE WHEN (t."X_45" < 5.000000) THEN CASE WHEN (t."X_0" < 6.000000) THEN 19 ELSE 20 END ELSE 10 END END ELSE CASE WHEN (t."X_16" < 6.000000) THEN CASE WHEN (t."X_43" < 10.000000) THEN CASE WHEN (t."X_12" < 10.000000) THEN CASE WHEN (t."X_45" < 8.000000) THEN CASE WHEN (t."X_0" < 6.000000) THEN 61 ELSE 62 END ELSE 38 END ELSE CASE WHEN (t."X_26" < 10.000000) THEN 39 ELSE 40 END END ELSE CASE WHEN (t."X_4" < 10.000000) THEN 23 ELSE 24 END END ELSE CASE WHEN (t."X_16" < 8.000000) THEN CASE WHEN (t."X_43" < 10.000000) THEN CASE WHEN (t."X_0" < 6.000000) THEN 41 ELSE 42 END ELSE 26 END ELSE CASE WHEN (t."X_30" < 10.000000) THEN CASE WHEN (t."X_0" < 6.000000) THEN 43 ELSE 44 END ELSE CASE WHEN (t."X_4" < 10.000000) THEN 45 ELSE 46 END END END END END AS node_id
  FROM model_input t
 )
,
"DT_node_data_1" AS 
...
"DT_node_lookup_2" AS 
 (SELECT
    t."index" AS "index",
    CASE WHEN (t."X_18" < 10.000000) THEN CASE WHEN (t."X_43" < 10.000000) THEN CASE WHEN (t."X_16" < 8.000000) THEN CASE WHEN (t."X_45" < 8.000000) THEN CASE WHEN (t."X_0" < 6.000000) THEN CASE WHEN (t."X_23" < 10.000000) THEN 47 ELSE 48 END ELSE CASE WHEN (t."X_28" < 10.000000) THEN 49 ELSE 50 END END ELSE CASE WHEN (t."X_0" < 6.000000) THEN CASE WHEN (t."X_26" < 10.000000) THEN 51 ELSE 52 END ELSE CASE WHEN (t."X_44" < 10.000000) THEN 53 ELSE 54 END END END ELSE CASE WHEN (t."X_45" < 8.000000) THEN CASE WHEN (t."X_0" < 6.000000) THEN CASE WHEN (t."X_15" < 10.000000) THEN 55 ELSE 56 END ELSE CASE WHEN (t."X_44" < 10.000000) THEN 57 ELSE 58 END END ELSE CASE WHEN (t."X_0" < 6.000000) THEN CASE WHEN (t."X_0" < 3.000000) THEN 59 ELSE 60 END ELSE CASE WHEN (t."X_26" < 10.000000) THEN 61 ELSE 62 END END END END ELSE CASE WHEN (t."X_0" < 3.000000) THEN CASE WHEN (t."X_32" < 10.000000) THEN 19 ELSE 20 END ELSE 10 END END ELSE CASE WHEN (t."X_16" < 6.000000) THEN CASE WHEN (t."X_12" < 10.000000) THEN CASE WHEN (t."X_26" < 10.000000) THEN CASE WHEN (t."X_47" < 10.000000) THEN 35 ELSE 36 END ELSE CASE WHEN (t."X_0" < 6.000000) THEN 37 ELSE 38 END END ELSE CASE WHEN (t."X_0" < 6.000000) THEN CASE WHEN (t."X_45" < 8.000000) THEN 39 ELSE 40 END ELSE CASE WHEN (t."X_45" < 5.000000) THEN 41 ELSE 42 END END END ELSE CASE WHEN (t."X_43" < 10.000000) THEN CASE WHEN (t."X_26" < 10.000000) THEN CASE WHEN (t."X_28" < 10.000000) THEN 43 ELSE 44 END ELSE CASE WHEN (t."X_4" < 10.000000) THEN 45 ELSE 46 END END ELSE 14 END END END AS node_id
  FROM model_input t
 )
,
"DT_node_data_2" AS 
...
"DT_node_lookup_3" AS 
 (SELECT
    t."index" AS "index",
    CASE WHEN (t."X_18" < 10.000000) THEN CASE WHEN (t."X_43" < 10.000000) THEN CASE WHEN (t."X_16" < 8.000000) THEN CASE WHEN (t."X_45" < 8.000000) THEN CASE WHEN (t."X_44" < 10.000000) THEN CASE WHEN (t."X_0" < 6.000000) THEN 45 ELSE 46 END ELSE CASE WHEN (t."X_16" < 6.000000) THEN 47 ELSE 48 END END ELSE CASE WHEN (t."X_0" < 3.000000) THEN CASE WHEN (t."X_52" < 10.000000) THEN 49 ELSE 50 END ELSE CASE WHEN (t."X_16" < 6.000000) THEN 51 ELSE 52 END END END ELSE CASE WHEN (t."X_11" < 10.000000) THEN CASE WHEN (t."X_26" < 10.000000) THEN CASE WHEN (t."X_13" < 10.000000) THEN 53 ELSE 54 END ELSE CASE WHEN (t."X_45" < 5.000000) THEN 55 ELSE 56 END END ELSE CASE WHEN (t."X_0" < 3.000000) THEN CASE WHEN (t."X_20" < 10.000000) THEN 57 ELSE 58 END ELSE CASE WHEN (t."X_45" < 8.000000) THEN 59 ELSE 60 END END END END ELSE CASE WHEN (t."X_0" < 3.000000) THEN 9 ELSE 10 END END ELSE CASE WHEN (t."X_16" < 7.000000) THEN CASE WHEN (t."X_26" < 10.000000) THEN CASE WHEN (t."X_27" < 10.000000) THEN CASE WHEN (t."X_30" < 10.000000) THEN CASE WHEN (t."X_0" < 6.000000) THEN 61 ELSE 62 END ELSE 34 END ELSE CASE WHEN (t."X_3" < 10.000000) THEN 35 ELSE 36 END END ELSE CASE WHEN (t."X_4" < 10.000000) THEN CASE WHEN (t."X_0" < 3.000000) THEN 37 ELSE 38 END ELSE CASE WHEN (t."X_8" < 3.000000) THEN 39 ELSE 40 END END END ELSE CASE WHEN (t."X_43" < 10.000000) THEN CASE WHEN (t."X_27" < 10.000000) THEN CASE WHEN (t."X_0" < 6.000000) THEN 41 ELSE 42 END ELSE CASE WHEN (t."X_45" < 8.000000) THEN 43 ELSE 44 END END ELSE 14 END END END AS node_id
  FROM model_input t
 )
,
"DT_node_data_3" AS 
...
"DT_node_lookup_4" AS 
 (SELECT
    t."index" AS "index",
    CASE WHEN (t."X_18" < 10.000000) THEN CASE WHEN (t."X_16" < 8.000000) THEN CASE WHEN (t."X_43" < 10.000000) THEN CASE WHEN (t."X_0" < 6.000000) THEN CASE WHEN (t."X_0" < 3.000000) THEN CASE WHEN (t."X_44" < 10.000000) THEN 47 ELSE 48 END ELSE CASE WHEN (t."X_45" < 8.000000) THEN 49 ELSE 50 END END ELSE CASE WHEN (t."X_42" < 10.000000) THEN CASE WHEN (t."X_26" < 10.000000) THEN 51 ELSE 52 END ELSE CASE WHEN (t."X_28" < 10.000000) THEN 53 ELSE 54 END END END ELSE CASE WHEN (t."X_45" < 5.000000) THEN 17 ELSE 18 END END ELSE CASE WHEN (t."X_43" < 10.000000) THEN CASE WHEN (t."X_0" < 3.000000) THEN CASE WHEN (t."X_20" < 10.000000) THEN 33 ELSE CASE WHEN (t."X_45" < 5.000000) THEN 55 ELSE 56 END END ELSE CASE WHEN (t."X_45" < 5.000000) THEN CASE WHEN (t."X_16" < 10.000000) THEN 57 ELSE 58 END ELSE CASE WHEN (t."X_44" < 10.000000) THEN 59 ELSE 60 END END END ELSE 10 END END ELSE CASE WHEN (t."X_16" < 6.000000) THEN CASE WHEN (t."X_43" < 10.000000) THEN CASE WHEN (t."X_45" < 5.000000) THEN CASE WHEN (t."X_36" < 10.000000) THEN CASE WHEN (t."X_3" < 10.000000) THEN 61 ELSE 62 END ELSE 38 END ELSE CASE WHEN (t."X_0" < 6.000000) THEN 39 ELSE 40 END END ELSE CASE WHEN (t."X_41" < 10.000000) THEN 23 ELSE 24 END END ELSE CASE WHEN (t."X_43" < 10.000000) THEN CASE WHEN (t."X_45" < 5.000000) THEN CASE WHEN (t."X_36" < 10.000000) THEN 41 ELSE 42 END ELSE CASE WHEN (t."X_4" < 10.000000) THEN 43 ELSE 44 END END ELSE CASE WHEN (t."X_0" < 10.000000) THEN 27 ELSE CASE WHEN (t."X_8" < 8.000000) THEN 45 ELSE 46 END END END END END AS node_id
  FROM model_input t
 )
,
"DT_node_data_4" AS 
