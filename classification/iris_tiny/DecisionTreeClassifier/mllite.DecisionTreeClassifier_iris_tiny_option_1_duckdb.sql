...
"DT_node_data" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.250000 AS "P_0", 0.437500 AS "P_1", 0.312500 AS "P_2", 1 AS "D", 0.437500 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  0.363636 AS "P_0", 0.636364 AS "P_1", 0.000000 AS "P_2", 1 AS "D", 0.636364 AS "DP"
    UNION ALL
