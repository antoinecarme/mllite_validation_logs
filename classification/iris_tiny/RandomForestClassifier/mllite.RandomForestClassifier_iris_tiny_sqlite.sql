 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      ...
      CASE WHEN((t."X_3" > 0.650000) AND (t."X_2" <= 5.200000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_3" > 0.650000) AND (t."X_2" > 5.200000)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
"DT_node_data_5" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.500000 AS "P_0", 0.312500 AS "P_1", 0.187500 AS "P_2", 0 AS "D", 0.500000 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.625000 AS "P_1", 0.375000 AS "P_2", 1 AS "D", 0.625000 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  0.000000 AS "P_0", 1.000000 AS "P_1", 0.000000 AS "P_2", 1 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 4 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
...
"DT_node_data_6" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.187500 AS "P_0", 0.562500 AS "P_1", 0.250000 AS "P_2", 1 AS "D", 0.562500 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  0.250000 AS "P_0", 0.750000 AS "P_1", 0.000000 AS "P_2", 1 AS "D", 0.750000 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      ...
      CASE WHEN((t."X_0" <= 6.350000) AND (t."X_3" <= 0.600000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_0" <= 6.350000) AND (t."X_3" > 0.600000)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
"DT_node_data_7" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.187500 AS "P_0", 0.437500 AS "P_1", 0.375000 AS "P_2", 1 AS "D", 0.437500 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  0.300000 AS "P_0", 0.700000 AS "P_1", 0.000000 AS "P_2", 1 AS "D", 0.700000 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
...
"DT_node_lookup_8" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_3" > 1.350000)) THEN 2 ELSE NULL END AS "Leaf_2",
      CASE WHEN((t."X_3" <= 1.350000) AND (t."X_3" <= 0.650000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_3" <= 1.350000) AND (t."X_3" > 0.650000)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
"DT_node_data_8" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.250000 AS "P_0", 0.125000 AS "P_1", 0.625000 AS "P_2", 2 AS "D", 0.625000 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  0.666667 AS "P_0", 0.333333 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 0.666667 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
...
"DT_node_lookup_9" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_2" <= 5.000000)) THEN 1 ELSE NULL END AS "Leaf_1",
...
"DT_node_data_9" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.000000 AS "P_0", 0.687500 AS "P_1", 0.312500 AS "P_2", 1 AS "D", 0.687500 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  0.000000 AS "P_0", 1.000000 AS "P_1", 0.000000 AS "P_2", 1 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
  ) AS "Values"),
"DT_Output_9" AS 
 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      ...
      CASE WHEN((t."X_0" > 6.350000)) THEN 2 ELSE NULL END AS "Leaf_2",
      CASE WHEN((t."X_0" <= 6.350000) AND (t."X_3" <= 0.600000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_0" <= 6.350000) AND (t."X_3" > 0.600000) AND (t."X_1" > 2.650000)) THEN 6 ELSE NULL END AS "Leaf_6",
      CASE WHEN((t."X_0" <= 6.350000) AND (t."X_3" > 0.600000) AND (t."X_1" <= 2.650000) AND (t."X_3" <= 1.250000)) THEN 7 ELSE NULL END AS "Leaf_7",
      CASE WHEN((t."X_0" <= 6.350000) AND (t."X_3" > 0.600000) AND (t."X_1" <= 2.650000) AND (t."X_3" > 1.250000)) THEN 8 ELSE NULL END AS "Leaf_8"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_0" > 6.350000)) THEN 2 ELSE NULL END AS "Leaf_2",
      CASE WHEN((t."X_0" <= 6.350000) AND (t."X_2" <= 2.300000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_0" <= 6.350000) AND (t."X_2" > 2.300000) AND (t."X_2" <= 5.150000)) THEN 5 ELSE NULL END AS "Leaf_5",
      CASE WHEN((t."X_0" <= 6.350000) AND (t."X_2" > 2.300000) AND (t."X_2" > 5.150000)) THEN 6 ELSE NULL END AS "Leaf_6"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
"DT_node_data_11" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.125000 AS "P_0", 0.500000 AS "P_1", 0.375000 AS "P_2", 1 AS "D", 0.500000 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  0.181818 AS "P_0", 0.727273 AS "P_1", 0.090909 AS "P_2", 1 AS "D", 0.727273 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 4 AS nid,  0.000000 AS "P_0", 0.888889 AS "P_1", 0.111111 AS "P_2", 1 AS "D", 0.888889 AS "DP"
    UNION ALL
 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_2" <= 2.300000)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_2" > 2.300000) AND (t."X_0" <= 6.250000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_2" > 2.300000) AND (t."X_0" > 6.250000)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
"DT_node_data_12" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.312500 AS "P_0", 0.375000 AS "P_1", 0.312500 AS "P_2", 1 AS "D", 0.375000 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.545455 AS "P_1", 0.454545 AS "P_2", 1 AS "D", 0.545455 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  0.000000 AS "P_0", 1.000000 AS "P_1", 0.000000 AS "P_2", 1 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 4 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
...
"DT_node_data_13" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.125000 AS "P_0", 0.312500 AS "P_1", 0.562500 AS "P_2", 2 AS "D", 0.562500 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  0.285714 AS "P_0", 0.714286 AS "P_1", 0.000000 AS "P_2", 1 AS "D", 0.714286 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      ...
      CASE WHEN((t."X_3" > 0.800000) AND (t."X_2" <= 5.000000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_3" > 0.800000) AND (t."X_2" > 5.000000)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
"DT_node_data_14" AS 
 (SELECT
  ...
  FROM (
    ...
    SELECT 1 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.363636 AS "P_1", 0.636364 AS "P_2", 2 AS "D", 0.636364 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  0.000000 AS "P_0", 1.000000 AS "P_1", 0.000000 AS "P_2", 1 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 4 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_3" > 1.850000)) THEN 2 ELSE NULL END AS "Leaf_2",
      CASE WHEN((t."X_3" <= 1.850000) AND (t."X_3" <= 0.800000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_3" <= 1.850000) AND (t."X_3" > 0.800000)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
"DT_node_data_15" AS 
 (SELECT
  ...
  FROM (
    SELECT 0 AS nid,  0.187500 AS "P_0", 0.375000 AS "P_1", 0.437500 AS "P_2", 2 AS "D", 0.437500 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  0.333333 AS "P_0", 0.666667 AS "P_1", 0.000000 AS "P_2", 1 AS "D", 0.666667 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
...
"DT_node_lookup_16" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_3" > 1.300000)) THEN 2 ELSE NULL END AS "Leaf_2",
      CASE WHEN((t."X_3" <= 1.300000) AND (t."X_3" <= 0.800000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_3" <= 1.300000) AND (t."X_3" > 0.800000)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
"DT_node_data_16" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.375000 AS "P_0", 0.062500 AS "P_1", 0.562500 AS "P_2", 2 AS "D", 0.562500 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  0.857143 AS "P_0", 0.142857 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 0.857143 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
...
"DT_node_data_17" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.437500 AS "P_0", 0.312500 AS "P_1", 0.250000 AS "P_2", 0 AS "D", 0.437500 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_2" > 5.000000)) THEN 2 ELSE NULL END AS "Leaf_2",
      CASE WHEN((t."X_2" <= 5.000000) AND (t."X_3" <= 0.650000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_2" <= 5.000000) AND (t."X_3" > 0.650000)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
"DT_node_data_18" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.062500 AS "P_0", 0.375000 AS "P_1", 0.562500 AS "P_2", 2 AS "D", 0.562500 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  0.142857 AS "P_0", 0.857143 AS "P_1", 0.000000 AS "P_2", 1 AS "D", 0.857143 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
...
"DT_node_lookup_19" AS 
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_0" > 6.000000)) THEN 2 ELSE NULL END AS "Leaf_2",
      CASE WHEN((t."X_0" <= 6.000000) AND (t."X_2" <= 2.300000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_0" <= 6.000000) AND (t."X_2" > 2.300000)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
"DT_node_data_19" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.062500 AS "P_0", 0.437500 AS "P_1", 0.500000 AS "P_2", 2 AS "D", 0.500000 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  0.125000 AS "P_0", 0.875000 AS "P_1", 0.000000 AS "P_2", 1 AS "D", 0.875000 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
...
"DT_node_data_20" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.312500 AS "P_0", 0.437500 AS "P_1", 0.250000 AS "P_2", 1 AS "D", 0.437500 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_0" > 6.350000)) THEN 2 ELSE NULL END AS "Leaf_2",
      CASE WHEN((t."X_0" <= 6.350000) AND (t."X_3" <= 0.650000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_0" <= 6.350000) AND (t."X_3" > 0.650000)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
"DT_node_data_21" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.125000 AS "P_0", 0.437500 AS "P_1", 0.437500 AS "P_2", 1 AS "D", 0.437500 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  0.222222 AS "P_0", 0.777778 AS "P_1", 0.000000 AS "P_2", 1 AS "D", 0.777778 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
...
"DT_node_data_22" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.250000 AS "P_0", 0.625000 AS "P_1", 0.125000 AS "P_2", 1 AS "D", 0.625000 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.833333 AS "P_1", 0.166667 AS "P_2", 1 AS "D", 0.833333 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  0.000000 AS "P_0", 1.000000 AS "P_1", 0.000000 AS "P_2", 1 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 4 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_2" <= 2.300000)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_2" > 2.300000) AND (t."X_3" > 1.950000)) THEN 4 ELSE NULL END AS "Leaf_4",
      CASE WHEN((t."X_2" > 2.300000) AND (t."X_3" <= 1.950000) AND (t."X_2" <= 5.050000)) THEN 5 ELSE NULL END AS "Leaf_5",
      CASE WHEN((t."X_2" > 2.300000) AND (t."X_3" <= 1.950000) AND (t."X_2" > 5.050000)) THEN 6 ELSE NULL END AS "Leaf_6"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
"DT_node_data_23" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.312500 AS "P_0", 0.562500 AS "P_1", 0.125000 AS "P_2", 1 AS "D", 0.562500 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.818182 AS "P_1", 0.181818 AS "P_2", 1 AS "D", 0.818182 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  0.000000 AS "P_0", 0.900000 AS "P_1", 0.100000 AS "P_2", 1 AS "D", 0.900000 AS "DP"
    UNION ALL
    SELECT 4 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 5 AS nid,  0.000000 AS "P_0", 1.000000 AS "P_1", 0.000000 AS "P_2", 1 AS "D", 1.000000 AS "DP"
...
"DT_node_data_24" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.687500 AS "P_0", 0.187500 AS "P_1", 0.125000 AS "P_2", 0 AS "D", 0.687500 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.600000 AS "P_1", 0.400000 AS "P_2", 1 AS "D", 0.600000 AS "DP"
 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_3" <= 0.700000)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_3" > 0.700000) AND (t."X_2" <= 5.150000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_3" > 0.700000) AND (t."X_2" > 5.150000)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      ...
      CASE WHEN((t."X_2" > 2.250000) AND (t."X_0" <= 6.250000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_2" > 2.250000) AND (t."X_0" > 6.250000)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_data_27" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.187500 AS "P_0", 0.500000 AS "P_1", 0.312500 AS "P_2", 1 AS "D", 0.500000 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  0.250000 AS "P_0", 0.666667 AS "P_1", 0.083333 AS "P_2", 1 AS "D", 0.666667 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      ...
      CASE WHEN((t."X_0" > 5.600000) AND (t."X_2" <= 5.150000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_0" > 5.600000) AND (t."X_2" > 5.150000)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      ...
      CASE WHEN((t."X_3" > 0.750000) AND (t."X_2" <= 5.000000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_3" > 0.750000) AND (t."X_2" > 5.000000)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_data_30" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.437500 AS "P_0", 0.437500 AS "P_1", 0.125000 AS "P_2", 0 AS "D", 0.437500 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
 ...
 (SELECT
  ...
  FROM
   ...
   (SELECT
      t."index" AS "index",
      CASE WHEN((t."X_3" <= 0.600000)) THEN 1 ELSE NULL END AS "Leaf_1",
      CASE WHEN((t."X_3" > 0.600000) AND (t."X_2" <= 5.300000)) THEN 3 ELSE NULL END AS "Leaf_3",
      CASE WHEN((t."X_3" > 0.600000) AND (t."X_2" > 5.300000)) THEN 4 ELSE NULL END AS "Leaf_4"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
"DT_node_data_31" AS 
 (SELECT
    ...
    "Values"."DP" AS "DP"
  FROM (
    SELECT 0 AS nid,  0.125000 AS "P_0", 0.812500 AS "P_1", 0.062500 AS "P_2", 1 AS "D", 0.812500 AS "DP"
    UNION ALL
    SELECT 1 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 2 AS nid,  0.000000 AS "P_0", 0.928571 AS "P_1", 0.071429 AS "P_2", 1 AS "D", 0.928571 AS "DP"
    UNION ALL
    SELECT 3 AS nid,  0.000000 AS "P_0", 1.000000 AS "P_1", 0.000000 AS "P_2", 1 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 4 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 2 AS "D", 1.000000 AS "DP"
