...
"ClassProblems" AS
 ( SELECT
   ...
   FROM
   (
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 0 AS "sv_idx", 2.211739 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 1 AS "sv_idx", 2.483410 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 2 AS "sv_idx", 2.211739 AS "Coeff"
     UNION ALL
     SELECT 0 AS "prob_idx", 0 AS "c_1", 1 AS "c_2", 3 AS "sv_idx", 2.483410 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 0 AS "sv_idx", 0.153596 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 1 AS "sv_idx", 1.268923 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 4 AS "sv_idx", 2.211739 AS "Coeff"
     UNION ALL
     SELECT 1 AS "prob_idx", 0 AS "c_1", 2 AS "c_2", 5 AS "sv_idx", 2.483410 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 2 AS "sv_idx", 0.153596 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 3 AS "sv_idx", 1.268923 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 4 AS "sv_idx", 0.153596 AS "Coeff"
     UNION ALL
     SELECT 2 AS "prob_idx", 1 AS "c_1", 2 AS "c_2", 5 AS "sv_idx", 1.268923 AS "Coeff"
   ) AS t
  ),
"SV_Rho" AS
 ( SELECT
   ...
   FROM
   (
     SELECT 0 AS "prob_idx", -0.032134 AS "rho", -1.541124 AS "probA", 0.129206 AS "probB"
     UNION ALL
     SELECT 1 AS "prob_idx", 0.027356 AS "rho", -1.698271 AS "probA", 0.098792 AS "probB"
     UNION ALL
     SELECT 2 AS "prob_idx", 0.390362 AS "rho", -1.144298 AS "probA", 0.199394 AS "probB"
   ) AS t
  ),
"Competition" AS
( SELECT 
