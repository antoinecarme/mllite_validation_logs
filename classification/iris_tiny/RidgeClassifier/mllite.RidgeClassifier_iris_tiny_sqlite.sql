...
model_scores_cte AS 
 (SELECT t."index" AS "index",
   -2.370631 + 0.071604 * t."X_0" + 0.937354 * t."X_1" + -0.194516 * t."X_2" + -0.532735 * t."X_3" AS "Score_0",
   CAST(NULL AS FLOAT) AS "Proba_0",
   CAST(NULL AS FLOAT) AS "LogProba_0",
   5.983428 + -0.424803 * t."X_0" + -1.264203 * t."X_1" + -0.036332 * t."X_2" + 0.352726 * t."X_3" AS "Score_1",
   CAST(NULL AS FLOAT) AS "Proba_1",
   CAST(NULL AS FLOAT) AS "LogProba_1",
   -4.612794 + 0.353199 * t."X_0" + 0.326849 * t."X_1" + 0.230847 * t."X_2" + 0.180010 * t."X_3" AS "Score_2",
