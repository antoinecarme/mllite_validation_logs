...
model_scores_cte AS 
 (SELECT model_input."index" AS "index",
   0.087861 + -0.105409 * X_0 + 0.152266 * X_1 + -0.007001 * X_2 + -0.130613 * X_3 AS "Score_0", CAST(NULL AS FLOAT) AS "Proba_0", CAST(NULL AS FLOAT) AS "LogProba_0",
   0.821441 + 0.254322 * X_0 + -0.214554 * X_1 + -0.266651 * X_2 + -0.022583 * X_3 AS "Score_1", CAST(NULL AS FLOAT) AS "Proba_1", CAST(NULL AS FLOAT) AS "LogProba_1",
   -1.909308 + -0.148914 * X_0 + 0.062288 * X_1 + 0.273655 * X_2 + 0.153195 * X_3 AS "Score_2", CAST(NULL AS FLOAT) AS "Proba_2", CAST(NULL AS FLOAT) AS "LogProba_2"
  FROM model_input
 )
,
