...
"DT_node_lookup" AS 
 (SELECT
    t."index" AS "index",
    COALESCE( t1."Leaf_9", t1."Leaf_11", t1."Leaf_12", t1."Leaf_13", t1."Leaf_14", t1."Leaf_15", t1."Leaf_19", t1."Leaf_21", t1."Leaf_22", t1."Leaf_23", t1."Leaf_24", t1."Leaf_26", t1."Leaf_27", t1."Leaf_28", t1."Leaf_30", t1."Leaf_33", t1."Leaf_35", t1."Leaf_36", t1."Leaf_39", t1."Leaf_40", t1."Leaf_41", t1."Leaf_42" ) AS node_id
  FROM
    model_input t
    LEFT OUTER JOIN
   (SELECT
      ...
      CASE WHEN((t."X_22" > 5.500000) AND (t."X_22" <= 6.500000) AND (t."X_24" <= 5.500000) AND (t."X_1" <= 6.500000) AND (t."X_5" > 1.500000) AND (t."X_29" <= 1.500000)) THEN 23 ELSE NULL END AS Leaf_23,
      ...
      CASE WHEN((t."X_22" > 5.500000) AND (t."X_22" > 6.500000) AND (t."X_27" > 3.500000)) THEN 26 ELSE NULL END AS Leaf_26,
      CASE WHEN((t."X_22" > 5.500000) AND (t."X_22" > 6.500000) AND (t."X_27" <= 3.500000) AND (t."X_1" <= 6.500000)) THEN 27 ELSE NULL END AS Leaf_27,
      CASE WHEN((t."X_22" > 5.500000) AND (t."X_22" > 6.500000) AND (t."X_27" <= 3.500000) AND (t."X_1" > 6.500000)) THEN 28 ELSE NULL END AS Leaf_28,
      CASE WHEN((t."X_22" <= 5.500000) AND (t."X_27" <= 6.500000) AND (t."X_10" > 8.500000)) THEN 30 ELSE NULL END AS Leaf_30,
      CASE WHEN((t."X_22" <= 5.500000) AND (t."X_27" <= 6.500000) AND (t."X_10" <= 8.500000) AND (t."X_27" > 5.500000) AND (t."X_1" <= 6.500000)) THEN 33 ELSE NULL END AS Leaf_33,
      CASE WHEN((t."X_22" <= 5.500000) AND (t."X_27" <= 6.500000) AND (t."X_10" <= 8.500000) AND (t."X_27" > 5.500000) AND (t."X_1" > 6.500000) AND (t."X_16" <= 4.500000)) THEN 35 ELSE NULL END AS Leaf_35,
      CASE WHEN((t."X_22" <= 5.500000) AND (t."X_27" <= 6.500000) AND (t."X_10" <= 8.500000) AND (t."X_27" > 5.500000) AND (t."X_1" > 6.500000) AND (t."X_16" > 4.500000)) THEN 36 ELSE NULL END AS Leaf_36,
      CASE WHEN((t."X_22" <= 5.500000) AND (t."X_27" <= 6.500000) AND (t."X_10" <= 8.500000) AND (t."X_27" <= 5.500000) AND (t."X_10" > 7.500000) AND (t."X_15" <= 2.000000)) THEN 39 ELSE NULL END AS Leaf_39,
      CASE WHEN((t."X_22" <= 5.500000) AND (t."X_27" <= 6.500000) AND (t."X_10" <= 8.500000) AND (t."X_27" <= 5.500000) AND (t."X_10" > 7.500000) AND (t."X_15" > 2.000000)) THEN 40 ELSE NULL END AS Leaf_40,
      CASE WHEN((t."X_22" <= 5.500000) AND (t."X_27" <= 6.500000) AND (t."X_10" <= 8.500000) AND (t."X_27" <= 5.500000) AND (t."X_10" <= 7.500000) AND (t."X_23" <= 5.500000)) THEN 41 ELSE NULL END AS Leaf_41,
      CASE WHEN((t."X_22" <= 5.500000) AND (t."X_27" <= 6.500000) AND (t."X_10" <= 8.500000) AND (t."X_27" <= 5.500000) AND (t."X_10" <= 7.500000) AND (t."X_23" > 5.500000)) THEN 42 ELSE NULL END AS Leaf_42
    FROM model_input t
    ) AS t1
    ON(t."index" == t1."index")
 ),
"DT_node_data" AS 
 (SELECT
  ...
  FROM (
    ...
    UNION ALL
    SELECT 29 AS nid,  0.021148 AS "P_0", 0.978852 AS "P_1", 1 AS "D", 0.978852 AS "DP"
    UNION ALL
    SELECT 30 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 31 AS nid,  0.009615 AS "P_0", 0.990385 AS "P_1", 1 AS "D", 0.990385 AS "DP"
    UNION ALL
    SELECT 32 AS nid,  0.210526 AS "P_0", 0.789474 AS "P_1", 1 AS "D", 0.789474 AS "DP"
    UNION ALL
    ...
    UNION ALL
    SELECT 37 AS nid,  0.006557 AS "P_0", 0.993443 AS "P_1", 1 AS "D", 0.993443 AS "DP"
    UNION ALL
    ...
    UNION ALL
    SELECT 41 AS nid,  0.003390 AS "P_0", 0.996610 AS "P_1", 1 AS "D", 0.996610 AS "DP"
    UNION ALL
