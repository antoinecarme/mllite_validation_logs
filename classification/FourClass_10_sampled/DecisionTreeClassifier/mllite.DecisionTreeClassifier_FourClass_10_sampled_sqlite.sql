...
"DT_node_lookup" AS 
 (SELECT
    t."index" AS "index",
    COALESCE( t1."Leaf_7", t1."Leaf_9", t1."Leaf_11", t1."Leaf_12", t1."Leaf_15", t1."Leaf_16", t1."Leaf_19", t1."Leaf_20", t1."Leaf_21", t1."Leaf_22", t1."Leaf_25", t1."Leaf_27", t1."Leaf_29", t1."Leaf_31", t1."Leaf_32", t1."Leaf_35", t1."Leaf_37", t1."Leaf_38", t1."Leaf_40", t1."Leaf_41", t1."Leaf_43", t1."Leaf_49", t1."Leaf_50", t1."Leaf_51", t1."Leaf_52", t1."Leaf_56", t1."Leaf_57", t1."Leaf_58", t1."Leaf_61", t1."Leaf_62", t1."Leaf_64", t1."Leaf_65", t1."Leaf_66", t1."Leaf_69", t1."Leaf_70", t1."Leaf_71", t1."Leaf_73", t1."Leaf_74" ) AS node_id
  FROM
    "model_input" AS t
    LEFT OUTER JOIN
   (SELECT
      ...
      CASE WHEN((t."X_8" <= 0.152687) AND (t."X_3" <= 0.558276) AND (t."X_7" <= -1.125393) AND (t."X_2" > -1.200194) AND (t."X_4" > -0.975906) AND (t."X_0" > 0.427335) AND (t."X_9" <= -0.499828)) THEN 31 ELSE NULL END AS "Leaf_31",
      CASE WHEN((t."X_8" <= 0.152687) AND (t."X_3" <= 0.558276) AND (t."X_7" <= -1.125393) AND (t."X_2" > -1.200194) AND (t."X_4" > -0.975906) AND (t."X_0" > 0.427335) AND (t."X_9" > -0.499828)) THEN 32 ELSE NULL END AS "Leaf_32",
      CASE WHEN((t."X_8" <= 0.152687) AND (t."X_3" <= 0.558276) AND (t."X_7" > -1.125393) AND (t."X_2" > 1.546596) AND (t."X_5" <= -0.262668)) THEN 35 ELSE NULL END AS "Leaf_35",
      CASE WHEN((t."X_8" <= 0.152687) AND (t."X_3" <= 0.558276) AND (t."X_7" > -1.125393) AND (t."X_2" > 1.546596) AND (t."X_5" > -0.262668) AND (t."X_9" <= 0.352333)) THEN 37 ELSE NULL END AS "Leaf_37",
      CASE WHEN((t."X_8" <= 0.152687) AND (t."X_3" <= 0.558276) AND (t."X_7" > -1.125393) AND (t."X_2" > 1.546596) AND (t."X_5" > -0.262668) AND (t."X_9" > 0.352333)) THEN 38 ELSE NULL END AS "Leaf_38",
      CASE WHEN((t."X_8" > 0.152687) AND (t."X_7" > -0.989518) AND (t."X_3" <= 1.240127) AND (t."X_2" > 1.909400)) THEN 40 ELSE NULL END AS "Leaf_40",
      CASE WHEN((t."X_8" > 0.152687) AND (t."X_7" > -0.989518) AND (t."X_3" <= 1.240127) AND (t."X_2" <= 1.909400) AND (t."X_6" <= -4.086171)) THEN 41 ELSE NULL END AS "Leaf_41",
      CASE WHEN((t."X_8" <= 0.152687) AND (t."X_3" <= 0.558276) AND (t."X_7" > -1.125393) AND (t."X_2" <= 1.546596) AND (t."X_0" <= -2.893364)) THEN 43 ELSE NULL END AS "Leaf_43",
      CASE WHEN((t."X_8" <= 0.152687) AND (t."X_3" <= 0.558276) AND (t."X_7" > -1.125393) AND (t."X_2" <= 1.546596) AND (t."X_0" > -2.893364) AND (t."X_4" > 0.571154) AND (t."X_4" <= 0.994495) AND (t."X_5" <= -0.415684)) THEN 49 ELSE NULL END AS "Leaf_49",
      CASE WHEN((t."X_8" <= 0.152687) AND (t."X_3" <= 0.558276) AND (t."X_7" > -1.125393) AND (t."X_2" <= 1.546596) AND (t."X_0" > -2.893364) AND (t."X_4" > 0.571154) AND (t."X_4" <= 0.994495) AND (t."X_5" > -0.415684)) THEN 50 ELSE NULL END AS "Leaf_50",
      CASE WHEN((t."X_8" <= 0.152687) AND (t."X_3" <= 0.558276) AND (t."X_7" > -1.125393) AND (t."X_2" <= 1.546596) AND (t."X_0" > -2.893364) AND (t."X_4" > 0.571154) AND (t."X_4" > 0.994495) AND (t."X_7" <= 1.565480)) THEN 51 ELSE NULL END AS "Leaf_51",
      CASE WHEN((t."X_8" <= 0.152687) AND (t."X_3" <= 0.558276) AND (t."X_7" > -1.125393) AND (t."X_2" <= 1.546596) AND (t."X_0" > -2.893364) AND (t."X_4" > 0.571154) AND (t."X_4" > 0.994495) AND (t."X_7" > 1.565480)) THEN 52 ELSE NULL END AS "Leaf_52",
      CASE WHEN((t."X_8" > 0.152687) AND (t."X_7" > -0.989518) AND (t."X_3" <= 1.240127) AND (t."X_2" <= 1.909400) AND (t."X_6" > -4.086171) AND (t."X_6" <= -2.206362) AND (t."X_3" > -0.971887)) THEN 56 ELSE NULL END AS "Leaf_56",
      CASE WHEN((t."X_8" > 0.152687) AND (t."X_7" > -0.989518) AND (t."X_3" <= 1.240127) AND (t."X_2" <= 1.909400) AND (t."X_6" > -4.086171) AND (t."X_6" <= -2.206362) AND (t."X_3" <= -0.971887) AND (t."X_4" <= 0.085674)) THEN 57 ELSE NULL END AS "Leaf_57",
      CASE WHEN((t."X_8" > 0.152687) AND (t."X_7" > -0.989518) AND (t."X_3" <= 1.240127) AND (t."X_2" <= 1.909400) AND (t."X_6" > -4.086171) AND (t."X_6" <= -2.206362) AND (t."X_3" <= -0.971887) AND (t."X_4" > 0.085674)) THEN 58 ELSE NULL END AS "Leaf_58",
      CASE WHEN((t."X_8" > 0.152687) AND (t."X_7" > -0.989518) AND (t."X_3" <= 1.240127) AND (t."X_2" <= 1.909400) AND (t."X_6" > -4.086171) AND (t."X_6" > -2.206362) AND (t."X_2" <= -1.220546) AND (t."X_0" <= 1.285295)) THEN 61 ELSE NULL END AS "Leaf_61",
      CASE WHEN((t."X_8" > 0.152687) AND (t."X_7" > -0.989518) AND (t."X_3" <= 1.240127) AND (t."X_2" <= 1.909400) AND (t."X_6" > -4.086171) AND (t."X_6" > -2.206362) AND (t."X_2" <= -1.220546) AND (t."X_0" > 1.285295)) THEN 62 ELSE NULL END AS "Leaf_62",
      CASE WHEN((t."X_8" > 0.152687) AND (t."X_7" > -0.989518) AND (t."X_3" <= 1.240127) AND (t."X_2" <= 1.909400) AND (t."X_6" > -4.086171) AND (t."X_6" > -2.206362) AND (t."X_2" > -1.220546) AND (t."X_8" > 0.208819)) THEN 64 ELSE NULL END AS "Leaf_64",
      CASE WHEN((t."X_8" > 0.152687) AND (t."X_7" > -0.989518) AND (t."X_3" <= 1.240127) AND (t."X_2" <= 1.909400) AND (t."X_6" > -4.086171) AND (t."X_6" > -2.206362) AND (t."X_2" > -1.220546) AND (t."X_8" <= 0.208819) AND (t."X_4" <= -0.547786)) THEN 65 ELSE NULL END AS "Leaf_65",
      CASE WHEN((t."X_8" > 0.152687) AND (t."X_7" > -0.989518) AND (t."X_3" <= 1.240127) AND (t."X_2" <= 1.909400) AND (t."X_6" > -4.086171) AND (t."X_6" > -2.206362) AND (t."X_2" > -1.220546) AND (t."X_8" <= 0.208819) AND (t."X_4" > -0.547786)) THEN 66 ELSE NULL END AS "Leaf_66",
      CASE WHEN((t."X_8" <= 0.152687) AND (t."X_3" <= 0.558276) AND (t."X_7" > -1.125393) AND (t."X_2" <= 1.546596) AND (t."X_0" > -2.893364) AND (t."X_4" <= 0.571154) AND (t."X_3" > 0.184918) AND (t."X_2" <= -1.001855)) THEN 69 ELSE NULL END AS "Leaf_69",
      CASE WHEN((t."X_8" <= 0.152687) AND (t."X_3" <= 0.558276) AND (t."X_7" > -1.125393) AND (t."X_2" <= 1.546596) AND (t."X_0" > -2.893364) AND (t."X_4" <= 0.571154) AND (t."X_3" > 0.184918) AND (t."X_2" > -1.001855)) THEN 70 ELSE NULL END AS "Leaf_70",
      CASE WHEN((t."X_8" <= 0.152687) AND (t."X_3" <= 0.558276) AND (t."X_7" > -1.125393) AND (t."X_2" <= 1.546596) AND (t."X_0" > -2.893364) AND (t."X_4" <= 0.571154) AND (t."X_3" <= 0.184918) AND (t."X_2" <= 0.404094)) THEN 71 ELSE NULL END AS "Leaf_71",
      CASE WHEN((t."X_8" <= 0.152687) AND (t."X_3" <= 0.558276) AND (t."X_7" > -1.125393) AND (t."X_2" <= 1.546596) AND (t."X_0" > -2.893364) AND (t."X_4" <= 0.571154) AND (t."X_3" <= 0.184918) AND (t."X_2" > 0.404094) AND (t."X_4" <= 0.148250)) THEN 73 ELSE NULL END AS "Leaf_73",
      CASE WHEN((t."X_8" <= 0.152687) AND (t."X_3" <= 0.558276) AND (t."X_7" > -1.125393) AND (t."X_2" <= 1.546596) AND (t."X_0" > -2.893364) AND (t."X_4" <= 0.571154) AND (t."X_3" <= 0.184918) AND (t."X_2" > 0.404094) AND (t."X_4" > 0.148250)) THEN 74 ELSE NULL END AS "Leaf_74"
...
"DT_node_data" AS 
 (SELECT
  ...
  FROM (
    ...
    UNION ALL
    SELECT 33 AS nid,  0.117647 AS "P_0", 0.088235 AS "P_1", 0.764706 AS "P_2", 0.029412 AS "P_3", 2 AS "D", 0.764706 AS "DP"
    UNION ALL
    SELECT 34 AS nid,  0.500000 AS "P_0", 0.250000 AS "P_1", 0.000000 AS "P_2", 0.250000 AS "P_3", 0 AS "D", 0.500000 AS "DP"
    UNION ALL
    ...
    UNION ALL
    SELECT 39 AS nid,  0.062500 AS "P_0", 0.843750 AS "P_1", 0.062500 AS "P_2", 0.031250 AS "P_3", 1 AS "D", 0.843750 AS "DP"
    UNION ALL
    ...
    UNION ALL
    SELECT 42 AS nid,  0.064516 AS "P_0", 0.870968 AS "P_1", 0.064516 AS "P_2", 0.000000 AS "P_3", 1 AS "D", 0.870968 AS "DP"
    UNION ALL
    SELECT 43 AS nid,  0.000000 AS "P_0", 1.000000 AS "P_1", 0.000000 AS "P_2", 0.000000 AS "P_3", 1 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 44 AS nid,  0.121212 AS "P_0", 0.060606 AS "P_1", 0.787879 AS "P_2", 0.030303 AS "P_3", 2 AS "D", 0.787879 AS "DP"
    UNION ALL
    SELECT 45 AS nid,  0.045455 AS "P_0", 0.045455 AS "P_1", 0.909091 AS "P_2", 0.000000 AS "P_3", 2 AS "D", 0.909091 AS "DP"
    UNION ALL
    SELECT 46 AS nid,  0.272727 AS "P_0", 0.090909 AS "P_1", 0.545455 AS "P_2", 0.090909 AS "P_3", 2 AS "D", 0.545455 AS "DP"
    UNION ALL
    SELECT 47 AS nid,  0.750000 AS "P_0", 0.000000 AS "P_1", 0.000000 AS "P_2", 0.250000 AS "P_3", 0 AS "D", 0.750000 AS "DP"
    UNION ALL
    SELECT 48 AS nid,  0.000000 AS "P_0", 0.142857 AS "P_1", 0.857143 AS "P_2", 0.000000 AS "P_3", 2 AS "D", 0.857143 AS "DP"
    UNION ALL
    ...
    UNION ALL
    SELECT 53 AS nid,  0.250000 AS "P_0", 0.500000 AS "P_1", 0.250000 AS "P_2", 0.000000 AS "P_3", 1 AS "D", 0.500000 AS "DP"
    UNION ALL
    SELECT 54 AS nid,  0.037037 AS "P_0", 0.925926 AS "P_1", 0.037037 AS "P_2", 0.000000 AS "P_3", 1 AS "D", 0.925926 AS "DP"
    UNION ALL
    SELECT 55 AS nid,  0.500000 AS "P_0", 0.000000 AS "P_1", 0.500000 AS "P_2", 0.000000 AS "P_3", 0 AS "D", 0.500000 AS "DP"
    UNION ALL
    ...
    UNION ALL
    SELECT 59 AS nid,  0.500000 AS "P_0", 0.500000 AS "P_1", 0.000000 AS "P_2", 0.000000 AS "P_3", 0 AS "D", 0.500000 AS "DP"
    UNION ALL
    SELECT 60 AS nid,  0.000000 AS "P_0", 0.960000 AS "P_1", 0.040000 AS "P_2", 0.000000 AS "P_3", 1 AS "D", 0.960000 AS "DP"
    UNION ALL
    ...
    UNION ALL
    SELECT 63 AS nid,  0.000000 AS "P_0", 0.500000 AS "P_1", 0.500000 AS "P_2", 0.000000 AS "P_3", 1 AS "D", 0.500000 AS "DP"
    UNION ALL
    ...
    UNION ALL
    SELECT 67 AS nid,  0.052632 AS "P_0", 0.000000 AS "P_1", 0.947368 AS "P_2", 0.000000 AS "P_3", 2 AS "D", 0.947368 AS "DP"
    UNION ALL
    SELECT 68 AS nid,  0.000000 AS "P_0", 0.333333 AS "P_1", 0.666667 AS "P_2", 0.000000 AS "P_3", 2 AS "D", 0.666667 AS "DP"
    UNION ALL
    ...
    UNION ALL
    SELECT 71 AS nid,  0.000000 AS "P_0", 0.000000 AS "P_1", 1.000000 AS "P_2", 0.000000 AS "P_3", 2 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 72 AS nid,  0.333333 AS "P_0", 0.000000 AS "P_1", 0.666667 AS "P_2", 0.000000 AS "P_3", 2 AS "D", 0.666667 AS "DP"
    UNION ALL
