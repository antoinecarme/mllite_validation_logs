...
model_scores_cte AS 
 (SELECT model_input."index" AS "index",
   ...
   -0.438023 + 0.095179 * X_0 + 0.037015 * X_1 + -0.012612 * X_2 + -0.048854 * X_3 + -0.021067 * X_4 + -0.067181 * X_5 + -0.009068 * X_6 + 0.266793 * X_7 + 0.191589 * X_8 + 0.027138 * X_9 AS "Score_1", CAST(NULL AS FLOAT) AS "Proba_1", CAST(NULL AS FLOAT) AS "LogProba_1",
   -0.495196 + 0.048662 * X_0 + 0.018958 * X_1 + -0.052142 * X_2 + -0.176423 * X_3 + -0.036897 * X_4 + 0.005759 * X_5 + 0.042509 * X_6 + 0.003855 * X_7 + -0.216087 * X_8 + -0.075775 * X_9 AS "Score_2", CAST(NULL AS FLOAT) AS "Proba_2", CAST(NULL AS FLOAT) AS "LogProba_2",
   -0.550525 + -0.074677 * X_0 + -0.023817 * X_1 + 0.030947 * X_2 + 0.099062 * X_3 + 0.108260 * X_4 + 0.073266 * X_5 + -0.018631 * X_6 + -0.165733 * X_7 + -0.011875 * X_8 + 0.085158 * X_9 AS "Score_3", CAST(NULL AS FLOAT) AS "Proba_3", CAST(NULL AS FLOAT) AS "LogProba_3"
  FROM model_input
 )
,
