...
"DT_node_lookup_0" AS 
 (SELECT
    t."index" AS "index",
    COALESCE( t1."Leaf_2", t1."Leaf_6", t1."Leaf_8", t1."Leaf_9", t1."Leaf_11", t1."Leaf_12", t1."Leaf_14", t1."Leaf_17", t1."Leaf_19", t1."Leaf_20", t1."Leaf_22", t1."Leaf_23", t1."Leaf_24" ) AS node_id
  FROM
    "model_input" AS t
    LEFT OUTER JOIN
   (SELECT
      ...
      CASE WHEN((t."X_44" <= 0.500000) AND (t."X_0" > 2.500000) AND (t."X_36" <= 0.500000) AND (t."X_3" <= 0.500000) AND (t."X_50" > 0.500000) AND (t."X_27" <= 0.500000)) THEN 11 ELSE NULL END AS "Leaf_11",
      ...
      CASE WHEN((t."X_44" <= 0.500000) AND (t."X_0" <= 2.500000) AND (t."X_12" > 0.500000)) THEN 14 ELSE NULL END AS "Leaf_14",
      CASE WHEN((t."X_44" <= 0.500000) AND (t."X_0" <= 2.500000) AND (t."X_12" <= 0.500000) AND (t."X_28" > 0.500000) AND (t."X_50" <= 0.500000)) THEN 17 ELSE NULL END AS "Leaf_17",
      CASE WHEN((t."X_44" <= 0.500000) AND (t."X_0" <= 2.500000) AND (t."X_12" <= 0.500000) AND (t."X_28" > 0.500000) AND (t."X_50" > 0.500000) AND (t."X_11" <= 0.500000)) THEN 19 ELSE NULL END AS "Leaf_19",
      CASE WHEN((t."X_44" <= 0.500000) AND (t."X_0" <= 2.500000) AND (t."X_12" <= 0.500000) AND (t."X_28" > 0.500000) AND (t."X_50" > 0.500000) AND (t."X_11" > 0.500000)) THEN 20 ELSE NULL END AS "Leaf_20",
      CASE WHEN((t."X_44" <= 0.500000) AND (t."X_0" <= 2.500000) AND (t."X_12" <= 0.500000) AND (t."X_28" <= 0.500000) AND (t."X_0" > 1.500000)) THEN 22 ELSE NULL END AS "Leaf_22",
      CASE WHEN((t."X_44" <= 0.500000) AND (t."X_0" <= 2.500000) AND (t."X_12" <= 0.500000) AND (t."X_28" <= 0.500000) AND (t."X_0" <= 1.500000) AND (t."X_36" <= 0.500000)) THEN 23 ELSE NULL END AS "Leaf_23",
      CASE WHEN((t."X_44" <= 0.500000) AND (t."X_0" <= 2.500000) AND (t."X_12" <= 0.500000) AND (t."X_28" <= 0.500000) AND (t."X_0" <= 1.500000) AND (t."X_36" > 0.500000)) THEN 24 ELSE NULL END AS "Leaf_24"
...
"DT_node_data_0" AS 
 (SELECT
  ...
  FROM (
    ...
    UNION ALL
    SELECT 13 AS nid,  0.903226 AS "P_0", 0.096774 AS "P_1", 0 AS "D", 0.903226 AS "DP"
    UNION ALL
    SELECT 14 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 15 AS nid,  0.960000 AS "P_0", 0.040000 AS "P_1", 0 AS "D", 0.960000 AS "DP"
    UNION ALL
    ...
    UNION ALL
    SELECT 21 AS nid,  0.941176 AS "P_0", 0.058824 AS "P_1", 0 AS "D", 0.941176 AS "DP"
    UNION ALL
...
"DT_node_lookup_1" AS 
 (SELECT
    t."index" AS "index",
    COALESCE( t1."Leaf_3", t1."Leaf_4", t1."Leaf_8", t1."Leaf_9", t1."Leaf_10", t1."Leaf_13", t1."Leaf_14", t1."Leaf_18", t1."Leaf_19", t1."Leaf_20", t1."Leaf_22", t1."Leaf_23", t1."Leaf_24" ) AS node_id
  FROM
    "model_input" AS t
    LEFT OUTER JOIN
   (SELECT
      ...
      CASE WHEN((t."X_11" <= 0.500000) AND (t."X_13" <= 0.500000) AND (t."X_28" <= 0.500000) AND (t."X_45" <= 2.500000) AND (t."X_8" <= 107546.500000) AND (t."X_0" > 2.500000)) THEN 24 ELSE NULL END AS "Leaf_24"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_2" AS 
 (SELECT
    t."index" AS "index",
    COALESCE( t1."Leaf_2", t1."Leaf_3", t1."Leaf_6", t1."Leaf_8", t1."Leaf_10", t1."Leaf_11", t1."Leaf_12" ) AS node_id
  FROM
    "model_input" AS t
    LEFT OUTER JOIN
   (SELECT
      ...
      CASE WHEN((t."X_34" <= 0.500000) AND (t."X_41" > 0.500000) AND (t."X_20" <= 0.500000) AND (t."X_35" <= 0.500000) AND (t."X_3" <= 0.500000) AND (t."X_0" <= 2.500000)) THEN 11 ELSE NULL END AS "Leaf_11",
      CASE WHEN((t."X_34" <= 0.500000) AND (t."X_41" > 0.500000) AND (t."X_20" <= 0.500000) AND (t."X_35" <= 0.500000) AND (t."X_3" <= 0.500000) AND (t."X_0" > 2.500000)) THEN 12 ELSE NULL END AS "Leaf_12"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
...
"DT_node_lookup_3" AS 
 (SELECT
    t."index" AS "index",
    COALESCE( t1."Leaf_3", t1."Leaf_6", t1."Leaf_7", t1."Leaf_11", t1."Leaf_12", t1."Leaf_13", t1."Leaf_14", t1."Leaf_17", t1."Leaf_18", t1."Leaf_21", t1."Leaf_22", t1."Leaf_24", t1."Leaf_26", t1."Leaf_27", t1."Leaf_28" ) AS node_id
  FROM
    "model_input" AS t
    LEFT OUTER JOIN
   (SELECT
      ...
      CASE WHEN((t."X_16" > 11.500000) AND (t."X_50" > 0.500000) AND (t."X_16" <= 14.500000) AND (t."X_18" > 0.500000) AND (t."X_16" <= 13.500000) AND (t."X_5" > 0.500000)) THEN 14 ELSE NULL END AS "Leaf_14",
      CASE WHEN((t."X_16" <= 11.500000) AND (t."X_5" > 0.500000) AND (t."X_8" <= 575098.500000)) THEN 17 ELSE NULL END AS "Leaf_17",
      CASE WHEN((t."X_16" <= 11.500000) AND (t."X_5" > 0.500000) AND (t."X_8" > 575098.500000)) THEN 18 ELSE NULL END AS "Leaf_18",
      CASE WHEN((t."X_16" <= 11.500000) AND (t."X_5" <= 0.500000) AND (t."X_26" > 0.500000) AND (t."X_50" <= 0.500000)) THEN 21 ELSE NULL END AS "Leaf_21",
      CASE WHEN((t."X_16" <= 11.500000) AND (t."X_5" <= 0.500000) AND (t."X_26" > 0.500000) AND (t."X_50" > 0.500000)) THEN 22 ELSE NULL END AS "Leaf_22",
      CASE WHEN((t."X_16" <= 11.500000) AND (t."X_5" <= 0.500000) AND (t."X_26" <= 0.500000) AND (t."X_3" > 0.500000)) THEN 24 ELSE NULL END AS "Leaf_24",
      CASE WHEN((t."X_16" <= 11.500000) AND (t."X_5" <= 0.500000) AND (t."X_26" <= 0.500000) AND (t."X_3" <= 0.500000) AND (t."X_4" > 0.500000)) THEN 26 ELSE NULL END AS "Leaf_26",
      CASE WHEN((t."X_16" <= 11.500000) AND (t."X_5" <= 0.500000) AND (t."X_26" <= 0.500000) AND (t."X_3" <= 0.500000) AND (t."X_4" <= 0.500000) AND (t."X_18" <= 0.500000)) THEN 27 ELSE NULL END AS "Leaf_27",
      CASE WHEN((t."X_16" <= 11.500000) AND (t."X_5" <= 0.500000) AND (t."X_26" <= 0.500000) AND (t."X_3" <= 0.500000) AND (t."X_4" <= 0.500000) AND (t."X_18" > 0.500000)) THEN 28 ELSE NULL END AS "Leaf_28"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
"DT_node_data_3" AS 
 (SELECT
  ...
  FROM (
    ...
    SELECT 18 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 19 AS nid,  0.900000 AS "P_0", 0.100000 AS "P_1", 0 AS "D", 0.900000 AS "DP"
    UNION ALL
    ...
    SELECT 22 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 23 AS nid,  0.972973 AS "P_0", 0.027027 AS "P_1", 0 AS "D", 0.972973 AS "DP"
    UNION ALL
    SELECT 24 AS nid,  0.000000 AS "P_0", 1.000000 AS "P_1", 1 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 25 AS nid,  0.968750 AS "P_0", 0.031250 AS "P_1", 0 AS "D", 0.968750 AS "DP"
    UNION ALL
...
"DT_node_lookup_4" AS 
 (SELECT
    t."index" AS "index",
    COALESCE( t1."Leaf_2", t1."Leaf_6", t1."Leaf_8", t1."Leaf_11", t1."Leaf_12", t1."Leaf_13", t1."Leaf_14", t1."Leaf_16", t1."Leaf_18", t1."Leaf_20", t1."Leaf_21", t1."Leaf_22" ) AS node_id
  FROM
    "model_input" AS t
    LEFT OUTER JOIN
   (SELECT
      ...
      CASE WHEN((t."X_15" <= 0.500000) AND (t."X_0" > 1.500000) AND (t."X_37" <= 0.500000) AND (t."X_39" <= 0.500000) AND (t."X_0" <= 3.500000) AND (t."X_35" <= 0.500000)) THEN 11 ELSE NULL END AS "Leaf_11",
      ...
      CASE WHEN((t."X_15" <= 0.500000) AND (t."X_0" > 1.500000) AND (t."X_37" <= 0.500000) AND (t."X_39" <= 0.500000) AND (t."X_0" > 3.500000) AND (t."X_4" <= 0.500000)) THEN 13 ELSE NULL END AS "Leaf_13",
      ...
      CASE WHEN((t."X_15" <= 0.500000) AND (t."X_0" <= 1.500000) AND (t."X_1" > 0.500000)) THEN 16 ELSE NULL END AS "Leaf_16",
      CASE WHEN((t."X_15" <= 0.500000) AND (t."X_0" <= 1.500000) AND (t."X_1" <= 0.500000) AND (t."X_34" > 0.500000)) THEN 18 ELSE NULL END AS "Leaf_18",
      CASE WHEN((t."X_15" <= 0.500000) AND (t."X_0" <= 1.500000) AND (t."X_1" <= 0.500000) AND (t."X_34" <= 0.500000) AND (t."X_35" > 0.500000)) THEN 20 ELSE NULL END AS "Leaf_20",
      CASE WHEN((t."X_15" <= 0.500000) AND (t."X_0" <= 1.500000) AND (t."X_1" <= 0.500000) AND (t."X_34" <= 0.500000) AND (t."X_35" <= 0.500000) AND (t."X_0" <= 0.500000)) THEN 21 ELSE NULL END AS "Leaf_21",
      CASE WHEN((t."X_15" <= 0.500000) AND (t."X_0" <= 1.500000) AND (t."X_1" <= 0.500000) AND (t."X_34" <= 0.500000) AND (t."X_35" <= 0.500000) AND (t."X_0" > 0.500000)) THEN 22 ELSE NULL END AS "Leaf_22"
    FROM "model_input" AS t
    ) AS t1
    ON(t."index" = t1."index")
 ),
"DT_node_data_4" AS 
 (SELECT
  ...
  FROM (
    ...
    UNION ALL
    SELECT 17 AS nid,  0.933333 AS "P_0", 0.066667 AS "P_1", 0 AS "D", 0.933333 AS "DP"
    UNION ALL
    SELECT 18 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
    SELECT 19 AS nid,  0.916667 AS "P_0", 0.083333 AS "P_1", 0 AS "D", 0.916667 AS "DP"
    UNION ALL
    SELECT 20 AS nid,  1.000000 AS "P_0", 0.000000 AS "P_1", 0 AS "D", 1.000000 AS "DP"
    UNION ALL
