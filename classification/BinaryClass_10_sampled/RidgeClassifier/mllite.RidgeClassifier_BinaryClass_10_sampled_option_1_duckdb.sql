...
model_scores_cte AS 
 (SELECT t."index" AS "index",
   ...
   0.5 * ( 0.039925 + 0.031302 * t."X_0" + 0.049832 * t."X_1" + 0.146315 * t."X_2" + -0.037260 * t."X_3" + -0.183652 * t."X_4" + 0.302052 * t."X_5" + 0.249603 * t."X_6" + 0.047503 * t."X_7" + -0.002003 * t."X_8" + -0.047692 * t."X_9" ) AS "Score_1",
