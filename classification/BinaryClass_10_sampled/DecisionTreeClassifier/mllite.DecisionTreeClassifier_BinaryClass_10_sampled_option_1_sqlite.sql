...
"DT_node_lookup" AS 
 (SELECT
    t."index" AS "index",
    COALESCE( t1."Leaf_3", t1."Leaf_8", t1."Leaf_10", t1."Leaf_11", t1."Leaf_12", t1."Leaf_14", t1."Leaf_16", t1."Leaf_18", t1."Leaf_19", t1."Leaf_20", t1."Leaf_25", t1."Leaf_26", t1."Leaf_27", t1."Leaf_29", t1."Leaf_30", t1."Leaf_32", t1."Leaf_33", t1."Leaf_35", t1."Leaf_36" ) AS node_id
  FROM
    "model_input" AS t
    LEFT OUTER JOIN
   (SELECT
      ...
      CASE WHEN((t."X_5" > 0.088803) AND (t."X_6" > -0.178653) AND (t."X_5" <= 0.860748) AND (t."X_6" <= 1.051927) AND (t."X_0" <= 1.277125) AND (t."X_2" <= 1.054227)) THEN 19 ELSE NULL END AS "Leaf_19",
      ...
      CASE WHEN((t."X_5" <= 0.088803) AND (t."X_3" > -0.967228) AND (t."X_5" > -0.482162) AND (t."X_5" <= -0.372423) AND (t."X_6" <= -0.598637)) THEN 25 ELSE NULL END AS "Leaf_25",
      CASE WHEN((t."X_5" <= 0.088803) AND (t."X_3" > -0.967228) AND (t."X_5" > -0.482162) AND (t."X_5" <= -0.372423) AND (t."X_6" > -0.598637)) THEN 26 ELSE NULL END AS "Leaf_26",
      CASE WHEN((t."X_5" <= 0.088803) AND (t."X_3" > -0.967228) AND (t."X_5" > -0.482162) AND (t."X_5" > -0.372423) AND (t."X_2" <= 0.533987)) THEN 27 ELSE NULL END AS "Leaf_27",
      CASE WHEN((t."X_5" <= 0.088803) AND (t."X_3" > -0.967228) AND (t."X_5" > -0.482162) AND (t."X_5" > -0.372423) AND (t."X_2" > 0.533987) AND (t."X_4" <= 1.014026)) THEN 29 ELSE NULL END AS "Leaf_29",
      CASE WHEN((t."X_5" <= 0.088803) AND (t."X_3" > -0.967228) AND (t."X_5" > -0.482162) AND (t."X_5" > -0.372423) AND (t."X_2" > 0.533987) AND (t."X_4" > 1.014026)) THEN 30 ELSE NULL END AS "Leaf_30",
      CASE WHEN((t."X_5" <= 0.088803) AND (t."X_3" > -0.967228) AND (t."X_5" <= -0.482162) AND (t."X_4" > 0.403673)) THEN 32 ELSE NULL END AS "Leaf_32",
      CASE WHEN((t."X_5" <= 0.088803) AND (t."X_3" > -0.967228) AND (t."X_5" <= -0.482162) AND (t."X_4" <= 0.403673) AND (t."X_4" <= -0.127147)) THEN 33 ELSE NULL END AS "Leaf_33",
      CASE WHEN((t."X_5" <= 0.088803) AND (t."X_3" > -0.967228) AND (t."X_5" <= -0.482162) AND (t."X_4" <= 0.403673) AND (t."X_4" > -0.127147) AND (t."X_2" <= -0.990929)) THEN 35 ELSE NULL END AS "Leaf_35",
      CASE WHEN((t."X_5" <= 0.088803) AND (t."X_3" > -0.967228) AND (t."X_5" <= -0.482162) AND (t."X_4" <= 0.403673) AND (t."X_4" > -0.127147) AND (t."X_2" > -0.990929)) THEN 36 ELSE NULL END AS "Leaf_36"
...
"DT_node_data" AS 
 (SELECT
  ...
  FROM (
    ...
    UNION ALL
    SELECT 31 AS nid,  0.823529 AS "P_0", 0.176471 AS "P_1", 0 AS "D", 0.823529 AS "DP"
    UNION ALL
